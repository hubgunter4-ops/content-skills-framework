...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-graphql/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-graphql/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-graphql/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-graphql/tests/test_smoke.py`
