---
name: generador-de-pruebas-de-selenium
description: Esta Skill genera pruebas de Selenium WebDriver en los principales lenguajes de programación para tareas de automatización de navegadores. Ofrece un amplio soporte del ecosistema y portabilidad, ayudando a los equipos a unificar sus capacidades de automatización y reutilizar scripts de prueba en diferentes proyectos.
---

# Generador de Pruebas de Selenium

## Propósito
Esta Skill genera pruebas de Selenium WebDriver en los principales lenguajes de programación para tareas de automatización de navegadores. Ofrece un amplio soporte del ecosistema y portabilidad, ayudando a los equipos a unificar sus capacidades de automatización y reutilizar scripts de prueba en diferentes proyectos.
...
- **Runner:** `toolkit/phase-3-programming/generador-de-pruebas-de-selenium/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/generador-de-pruebas-de-selenium/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/generador-de-pruebas-de-selenium/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/generador-de-pruebas-de-selenium/tests/test_smoke.py`
