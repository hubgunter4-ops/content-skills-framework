---
name: constructor-de-aplicaciones-gradio
description: Esta herramienta ayuda a los desarrolladores a crear aplicaciones Gradio y desplegarlas en Hugging Face Spaces. Al integrarse con el ecosistema de Hugging Face, simplifica el intercambio de modelos de aprendizaje automático y la creación de interfaces web interactivas sin una configuración de infraestructura compleja.
---

# Constructor de aplicaciones Gradio

## Propósito
Esta herramienta ayuda a los desarrolladores a crear aplicaciones Gradio y desplegarlas en Hugging Face Spaces. Al integrarse con el ecosistema de Hugging Face, simplifica el intercambio de modelos de aprendizaje automático y la creación de interfaces web interactivas sin una configuración de infraestructura compleja.
...
- **Runner:** `toolkit/phase-3-programming/constructor-de-aplicaciones-gradio/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/constructor-de-aplicaciones-gradio/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/constructor-de-aplicaciones-gradio/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/constructor-de-aplicaciones-gradio/tests/test_smoke.py`
