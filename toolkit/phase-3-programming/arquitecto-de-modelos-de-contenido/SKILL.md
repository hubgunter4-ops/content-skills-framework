...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-modelos-de-contenido/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-modelos-de-contenido/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-modelos-de-contenido/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-modelos-de-contenido/tests/test_smoke.py`
