...
description: Esta Skill aporta patrones de Remotion probados en batalla —transiciones personalizadas, componentes compartidos y convenciones de proyectos— para crear videos con código React. Te permite generar programáticamente videos animados con la imagen de marca, como demostraciones de funciones y animaciones de datos, con un control preciso y repetible.
---

# Remotion Toolkit

## Propósito
Esta Skill aporta patrones de Remotion probados en batalla —transiciones personalizadas, componentes compartidos y convenciones de proyectos— para crear videos con código React. Te permite generar programáticamente videos animados con la imagen de marca, como demostraciones de funciones y animaciones de datos, con un control preciso y repetible.
...
- **Runner:** `toolkit/phase-3-programming/remotion-toolkit/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/remotion-toolkit/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/remotion-toolkit/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/remotion-toolkit/tests/test_smoke.py`
