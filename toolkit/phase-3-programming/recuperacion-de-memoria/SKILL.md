...
- **Runner:** `toolkit/phase-3-programming/recuperacion-de-memoria/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/recuperacion-de-memoria/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/recuperacion-de-memoria/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/recuperacion-de-memoria/tests/test_smoke.py`
