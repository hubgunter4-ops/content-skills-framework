...
SKILL = {'name': 'Recuperación de Memoria', 'description': 'Esta es la habilidad oficial de recuperación de memoria de Zilliz para memsearch, que permite a su agente buscar y recordar decisiones, notas de depuración y conocimientos de sesiones pasadas. Presenta el contexto histórico adecuado en el momento oportuno, para que nunca tenga que volver a explicar trabajos anteriores ni repetir problemas ya resueltos.', 'slug': 'recuperacion-de-memoria'}
