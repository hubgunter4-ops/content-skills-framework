---
name: plantilla-de-habilidad-para-plugins
description: Esta habilidad proporciona una plantilla de referencia lista para usar para crear habilidades de plugins de Claude Code, incluyendo el frontmatter recomendado, la estructura de archivos, ejemplos de controladores y patrones de uso. Ayuda a los desarrolladores a arrancar rápidamente nuevas habilidades, seguir las mejores prácticas y producir archivos SKILL.md y código de controlador consistentes y bien formados para el desarrollo de plugins de Claude.
---

# Plantilla de Habilidad para Plugins

## Propósito
Esta habilidad proporciona una plantilla de referencia lista para usar para crear habilidades de plugins de Claude Code, incluyendo el frontmatter recomendado, la estructura de archivos, ejemplos de controladores y patrones de uso. Ayuda a los desarrolladores a arrancar rápidamente nuevas habilidades, seguir las mejores prácticas y producir archivos SKILL.md y código de controlador consistentes y bien formados para el desarrollo de plugins de Claude.
...
- **Runner:** `toolkit/phase-3-programming/plantilla-de-habilidad-para-plugins/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/plantilla-de-habilidad-para-plugins/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/plantilla-de-habilidad-para-plugins/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/plantilla-de-habilidad-para-plugins/tests/test_smoke.py`
