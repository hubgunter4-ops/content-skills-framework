---
name: flujo-de-trabajo-tdd
description: Esta es una guía metodológica para el desarrollo guiado por pruebas que impone la escritura de casos de prueba antes de implementar funcionalidades o corregir errores. Al establecer un flujo de trabajo de prueba primero, ayuda a los desarrolladores a detectar errores de forma temprana, reducir las regresiones y construir bases de código más robustas.
---

# Flujo de trabajo TDD

## Propósito
Esta es una guía metodológica para el desarrollo guiado por pruebas que impone la escritura de casos de prueba antes de implementar funcionalidades o corregir errores. Al establecer un flujo de trabajo de prueba primero, ayuda a los desarrolladores a detectar errores de forma temprana, reducir las regresiones y construir bases de código más robustas.
...
- **Runner:** `toolkit/phase-3-programming/flujo-de-trabajo-tdd/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/flujo-de-trabajo-tdd/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/flujo-de-trabajo-tdd/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/flujo-de-trabajo-tdd/tests/test_smoke.py`
