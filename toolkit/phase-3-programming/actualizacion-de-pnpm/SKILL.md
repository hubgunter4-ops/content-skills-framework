...
- **Runner:** `toolkit/phase-3-programming/actualizacion-de-pnpm/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/actualizacion-de-pnpm/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/actualizacion-de-pnpm/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/actualizacion-de-pnpm/tests/test_smoke.py`
