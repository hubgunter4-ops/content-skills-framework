...
description: Esta guía oficial de Supabase proporciona mejores prácticas de PostgreSQL, consejos de optimización y orientación arquitectónica para desarrolladores. Le ayuda a mejorar el rendimiento de la base de datos, implementar una seguridad de nivel de fila RLS robusta y crear arquitecturas de datos más eficientes dentro del ecosistema de Supabase.
---

# Mejores prácticas de Postgres

## Propósito
Esta guía oficial de Supabase proporciona mejores prácticas de PostgreSQL, consejos de optimización y orientación arquitectónica para desarrolladores. Le ayuda a mejorar el rendimiento de la base de datos, implementar una seguridad de nivel de fila RLS robusta y crear arquitecturas de datos más eficientes dentro del ecosistema de Supabase.
...
- **Runner:** `toolkit/phase-3-programming/mejores-practicas-de-postgres/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/mejores-practicas-de-postgres/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/mejores-practicas-de-postgres/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/mejores-practicas-de-postgres/tests/test_smoke.py`
