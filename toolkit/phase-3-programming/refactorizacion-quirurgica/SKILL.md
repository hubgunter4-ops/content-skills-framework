---
name: refactorizacion-quirurgica
description: Esta herramienta realiza una refactorización quirúrgica del código para mejorar la mantenibilidad sin cambiar el comportamiento del programa. Automatiza y sugiere ediciones específicas —extracción de funciones, cambio de nombre de variables, desglose de funciones grandes, refuerzo de tipos y eliminación de code smells—, permitiendo mejoras graduales y de bajo riesgo en toda su base de código.
---

# Refactorización Quirúrgica

## Propósito
Esta herramienta realiza una refactorización quirúrgica del código para mejorar la mantenibilidad sin cambiar el comportamiento del programa. Automatiza y sugiere ediciones específicas —extracción de funciones, cambio de nombre de variables, desglose de funciones grandes, refuerzo de tipos y eliminación de code smells—, permitiendo mejoras graduales y de bajo riesgo en toda su base de código.
...
- **Runner:** `toolkit/phase-3-programming/refactorizacion-quirurgica/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/refactorizacion-quirurgica/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/refactorizacion-quirurgica/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/refactorizacion-quirurgica/tests/test_smoke.py`
