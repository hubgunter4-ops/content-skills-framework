---
name: arquitecto-de-observabilidad
description: Esta guía sistemática de observabilidad ayuda a los desarrolladores a implementar registros estructurados, métricas y rastreo distribuido en el código de su aplicación. Al ofrecer mejores prácticas y listas de verificación estructuradas, ayuda a los equipos a detectar problemas de diseño como la explosión de cardinalidad de métricas durante la revisión, haciendo que los comportamientos de producción sean totalmente transparentes y diagnosticables.
---

# Arquitecto de Observabilidad

## Propósito
Esta guía sistemática de observabilidad ayuda a los desarrolladores a implementar registros estructurados, métricas y rastreo distribuido en el código de su aplicación. Al ofrecer mejores prácticas y listas de verificación estructuradas, ayuda a los equipos a detectar problemas de diseño como la explosión de cardinalidad de métricas durante la revisión, haciendo que los comportamientos de producción sean totalmente transparentes y diagnosticables.
...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-observabilidad/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-observabilidad/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-observabilidad/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-observabilidad/tests/test_smoke.py`
