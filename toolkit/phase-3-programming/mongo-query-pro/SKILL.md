...
description: Esta herramienta traduce solicitudes en lenguaje natural en consultas de MongoDB y pipelines de agregación ejecutables. Cierra la brecha entre el texto plano y las operaciones complejas de bases de datos, ayudando a desarrolladores y analistas a recuperar datos más rápido sin necesidad de escribir
---

# Mongo Query Pro

## Propósito
Esta herramienta traduce solicitudes en lenguaje natural en consultas de MongoDB y pipelines de agregación ejecutables. Cierra la brecha entre el texto plano y las operaciones complejas de bases de datos, ayudando a desarrolladores y analistas a recuperar datos más rápido sin necesidad de escribir
...
- **Runner:** `toolkit/phase-3-programming/mongo-query-pro/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/mongo-query-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/mongo-query-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/mongo-query-pro/tests/test_smoke.py`
