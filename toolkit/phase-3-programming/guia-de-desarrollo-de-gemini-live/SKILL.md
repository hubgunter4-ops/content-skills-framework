---
name: guia-de-desarrollo-de-gemini-live
description: Esta guía de desarrollo oficial de Google ayuda a los desarrolladores a crear aplicaciones de streaming bidireccional en tiempo real utilizando la API de Gemini Live. Proporciona instrucciones que van desde la implementación de conversaciones de voz hasta la optimización de la latencia, lo que permite a los equipos crear experiencias de IA interactivas.
---

# Guía de desarrollo de Gemini Live

## Propósito
Esta guía de desarrollo oficial de Google ayuda a los desarrolladores a crear aplicaciones de streaming bidireccional en tiempo real utilizando la API de Gemini Live. Proporciona instrucciones que van desde la implementación de conversaciones de voz hasta la optimización de la latencia, lo que permite a los equipos crear experiencias de IA interactivas.
...
- **Runner:** `toolkit/phase-3-programming/guia-de-desarrollo-de-gemini-live/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/guia-de-desarrollo-de-gemini-live/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/guia-de-desarrollo-de-gemini-live/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/guia-de-desarrollo-de-gemini-live/tests/test_smoke.py`
