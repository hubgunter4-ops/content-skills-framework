...
- **Runner:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-gcp/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-gcp/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-gcp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-gcp/tests/test_smoke.py`
