...
description: Esta es una habilidad de disciplina del conjunto de herramientas de superpoderes que prohíbe afirmar que el trabajo está completo sin ejecutar primero comandos de verificación actualizados. Obliga a realizar afirmaciones de finalización basadas en evidencia pruebas ejecutadas, compilaciones aprobadas, diferencias revisadas para que 'terminado' realmente signifique terminado.
---

# Verificar antes de terminar

## Propósito
Esta es una habilidad de disciplina del conjunto de herramientas de superpoderes que prohíbe afirmar que el trabajo está completo sin ejecutar primero comandos de verificación actualizados. Obliga a realizar afirmaciones de finalización basadas en evidencia pruebas ejecutadas, compilaciones aprobadas, diferencias revisadas para que 'terminado' realmente signifique terminado.
...
- **Runner:** `toolkit/phase-3-programming/verificar-antes-de-terminar/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/verificar-antes-de-terminar/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/verificar-antes-de-terminar/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/verificar-antes-de-terminar/tests/test_smoke.py`
