...
description: Esta habilidad proporciona patrones de diseño de DAG de Apache Airflow de nivel de producción, que cubren dependencias de tareas, sensores, manejo de errores y pruebas. Convierte las mejores prácticas dispersas en un flujo de trabajo ejecutable, ayudando a los ingenieros de datos a crear canalizaciones de datos robustas, orquestar flujos de trabajo complejos y programar tareas por lotes con confianza.
---

# Patrones de DAG de Airflow

## Propósito
Esta habilidad proporciona patrones de diseño de DAG de Apache Airflow de nivel de producción, que cubren dependencias de tareas, sensores, manejo de errores y pruebas. Convierte las mejores prácticas dispersas en un flujo de trabajo ejecutable, ayudando a los ingenieros de datos a crear canalizaciones de datos robustas, orquestar flujos de trabajo complejos y programar tareas por lotes con confianza.
...
- **Runner:** `toolkit/phase-3-programming/patrones-de-dag-de-airflow/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/patrones-de-dag-de-airflow/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/patrones-de-dag-de-airflow/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/patrones-de-dag-de-airflow/tests/test_smoke.py`
