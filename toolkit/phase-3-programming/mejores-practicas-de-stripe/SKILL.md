---
name: mejores-practicas-de-stripe
description: Esta guía oficial de integración de Stripe proporciona mejores prácticas y orientación arquitectónica para crear sistemas de pago seguros y confiables. Traduce la lógica de pago compleja en consejos de código accionables, ayudando a los desarrolladores a evitar errores comunes y a crear flujos de suscripción y manejo de webhooks robustos más rápido.
---

# Mejores prácticas de Stripe

## Propósito
Esta guía oficial de integración de Stripe proporciona mejores prácticas y orientación arquitectónica para crear sistemas de pago seguros y confiables. Traduce la lógica de pago compleja en consejos de código accionables, ayudando a los desarrolladores a evitar errores comunes y a crear flujos de suscripción y manejo de webhooks robustos más rápido.
...
- **Runner:** `toolkit/phase-3-programming/mejores-practicas-de-stripe/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/mejores-practicas-de-stripe/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/mejores-practicas-de-stripe/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/mejores-practicas-de-stripe/tests/test_smoke.py`
