...
description: Esta habilidad proporciona una guía de nivel de producción y plantillas de código para optimizar el rendimiento de los índices vectoriales, abarcando el ajuste de parámetros HNSW, estrategias de cuantificación y monitoreo del rendimiento. Ayuda a los desarrolladores que manejan búsquedas vectoriales a gran escala a equilibrar la latencia, la recuperación y el uso de memoria, permitiendo una infraestructura de recuperación más rápida y precisa.
---

# Optimizador de Índices Vectoriales

## Propósito
Esta habilidad proporciona una guía de nivel de producción y plantillas de código para optimizar el rendimiento de los índices vectoriales, abarcando el ajuste de parámetros HNSW, estrategias de cuantificación y monitoreo del rendimiento. Ayuda a los desarrolladores que manejan búsquedas vectoriales a gran escala a equilibrar la latencia, la recuperación y el uso de memoria, permitiendo una infraestructura de recuperación más rápida y precisa.
...
- **Runner:** `toolkit/phase-3-programming/optimizador-de-indices-vectoriales/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/optimizador-de-indices-vectoriales/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/optimizador-de-indices-vectoriales/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/optimizador-de-indices-vectoriales/tests/test_smoke.py`
