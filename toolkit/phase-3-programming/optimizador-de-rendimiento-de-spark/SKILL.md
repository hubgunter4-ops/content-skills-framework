...
description: Esta guía proporciona estrategias de optimización de rendimiento para Apache Spark, cubriendo la partición, la gestión de memoria, el ajuste de shuffle y el manejo de sesgo de datos. Equipa a los ingenieros de datos con ejemplos de código prácticos y patrones para depurar trabajos lentos y escalar canalizaciones de procesamiento de datos.
---

# Optimizador de Rendimiento de Spark

## Propósito
Esta guía proporciona estrategias de optimización de rendimiento para Apache Spark, cubriendo la partición, la gestión de memoria, el ajuste de shuffle y el manejo de sesgo de datos. Equipa a los ingenieros de datos con ejemplos de código prácticos y patrones para depurar trabajos lentos y escalar canalizaciones de procesamiento de datos.
...
- **Runner:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-spark/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-spark/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-spark/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/optimizador-de-rendimiento-de-spark/tests/test_smoke.py`
