...
- **Runner:** `toolkit/phase-3-programming/asistente-de-desarrollo-de-supabase/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/asistente-de-desarrollo-de-supabase/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/asistente-de-desarrollo-de-supabase/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/asistente-de-desarrollo-de-supabase/tests/test_smoke.py`
