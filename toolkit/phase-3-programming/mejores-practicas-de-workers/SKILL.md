---
name: mejores-practicas-de-workers
description: Esta herramienta de desarrollo oficial de Cloudflare le ayuda a revisar y crear código de Workers siguiendo las mejores prácticas de producción y las convenciones de wrangler.jsonc. Garantiza que sus aplicaciones estén configuradas correctamente, ayudando a los desarrolladores a desplegar una infraestructura en la nube robusta de manera eficiente.
---

# Mejores prácticas de Workers
...
- **Runner:** `toolkit/phase-3-programming/mejores-practicas-de-workers/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/mejores-practicas-de-workers/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/mejores-practicas-de-workers/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/mejores-practicas-de-workers/tests/test_smoke.py`
