...
- **Runner:** `toolkit/phase-3-programming/refactorizacion-de-markdown/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/refactorizacion-de-markdown/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/refactorizacion-de-markdown/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/refactorizacion-de-markdown/tests/test_smoke.py`
