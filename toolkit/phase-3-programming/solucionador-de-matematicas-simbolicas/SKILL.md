...
description: Esta Skill proporciona una guía de SymPy para matemáticas simbólicas exactas en Python, cubriendo álgebra, cálculo, resolución de ecuaciones y generación de código. Ayuda a los usuarios a realizar derivaciones matemáticas precisas, simplificar fórmulas y convertir expresiones simbólicas en código numérico ejecutable o formato LaTeX.
---

# Solucionador de matemáticas simbólicas

## Propósito
Esta Skill proporciona una guía de SymPy para matemáticas simbólicas exactas en Python, cubriendo álgebra, cálculo, resolución de ecuaciones y generación de código. Ayuda a los usuarios a realizar derivaciones matemáticas precisas, simplificar fórmulas y convertir expresiones simbólicas en código numérico ejecutable o formato LaTeX.
...
- **Runner:** `toolkit/phase-3-programming/solucionador-de-matematicas-simbolicas/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/solucionador-de-matematicas-simbolicas/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/solucionador-de-matematicas-simbolicas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/solucionador-de-matematicas-simbolicas/tests/test_smoke.py`
