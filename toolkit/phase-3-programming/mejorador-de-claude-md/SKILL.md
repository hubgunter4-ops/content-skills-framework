---
name: mejorador-de-claude-md
description: Esta habilidad audita y mejora archivos CLAUDE.md en un repositorio. Escanea archivos CLAUDE.md, los evalúa frente a plantillas y mejores prácticas, genera un informe de calidad y puede aplicar actualizaciones específicas para corregir problemas, optimizar la memoria del proyecto y simplificar el mantenimiento a largo plazo.
---

# Mejorador de CLAUDE.md

## Propósito
Esta habilidad audita y mejora archivos CLAUDE.md en un repositorio. Escanea archivos CLAUDE.md, los evalúa frente a plantillas y mejores prácticas, genera un informe de calidad y puede aplicar actualizaciones específicas para corregir problemas, optimizar la memoria del proyecto y simplificar el mantenimiento a largo plazo.
...
- **Runner:** `toolkit/phase-3-programming/mejorador-de-claude-md/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/mejorador-de-claude-md/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/mejorador-de-claude-md/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/mejorador-de-claude-md/tests/test_smoke.py`
