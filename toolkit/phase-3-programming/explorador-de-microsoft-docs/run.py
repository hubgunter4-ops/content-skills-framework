...
SKILL = {'name': 'Explorador de Microsoft Docs', 'description': 'Esta habilidad consulta la documentación oficial de Microsoft para explicar conceptos, encontrar tutoriales y aprender cómo funcionan los servicios en Azure, .NET, Microsoft 365, Windows, Power Platform y otras tecnologías de Microsoft. Recupera contenido fidedigno de learn.microsoft.com y sitios oficiales relacionados descripciones generales de arquitectura, inicios rápidos, guías de configuración, límites y mejores prácticas para ofrecer respuestas concisas y actualizadas.', 'slug': 'explorador-de-microsoft-docs'}
