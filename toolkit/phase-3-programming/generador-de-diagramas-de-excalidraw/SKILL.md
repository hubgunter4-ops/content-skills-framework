...
- **Runner:** `toolkit/phase-3-programming/generador-de-diagramas-de-excalidraw/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/generador-de-diagramas-de-excalidraw/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/generador-de-diagramas-de-excalidraw/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/generador-de-diagramas-de-excalidraw/tests/test_smoke.py`
