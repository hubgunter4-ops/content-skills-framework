...
SKILL = {'name': 'Grafana Dashboard Pro', 'description': 'Este kit de herramientas de monitoreo proporciona plantillas y mejores prácticas para crear tableros de Grafana listos para producción utilizando las metodologías RED y USE. Ayuda a los equipos a construir rápidamente interfaces de visualización profesionales para métricas de sistemas y aplicaciones, facilitando el establecimiento de una observabilidad operativa robusta.', 'slug': 'grafana-dashboard-pro'}
