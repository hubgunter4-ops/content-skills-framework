---
name: arquitecto-de-excalidraw
description: Esta Skill delega las operaciones de archivos de Excalidraw a subagentes, evitando que el JSON detallado agote el contexto del agente principal. Permite la lectura, modificación y creación eficiente de diagramas de arquitectura y diagramas de flujo sin interrumpir el flujo de trabajo principal.
---

# Arquitecto de Excalidraw

## Propósito
Esta Skill delega las operaciones de archivos de Excalidraw a subagentes, evitando que el JSON detallado agote el contexto del agente principal. Permite la lectura, modificación y creación eficiente de diagramas de arquitectura y diagramas de flujo sin interrumpir el flujo de trabajo principal.
...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-excalidraw/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-excalidraw/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-excalidraw/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-excalidraw/tests/test_smoke.py`
