...
SKILL = {'name': 'Perspectivas de ingeniería', 'description': 'Esta herramienta de análisis de código extrae lecciones de ingeniería de software del historial reciente de commits de Git y de los cambios de código. Destaca las mejores prácticas y áreas de mejora, ayudando a los desarrolladores a reflexionar sobre su trabajo y a mejorar continuamente sus habilidades de programación.', 'slug': 'perspectivas-de-ingenieria'}
