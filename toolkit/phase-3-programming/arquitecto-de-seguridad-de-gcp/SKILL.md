...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-seguridad-de-gcp/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-seguridad-de-gcp/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-seguridad-de-gcp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-seguridad-de-gcp/tests/test_smoke.py`
