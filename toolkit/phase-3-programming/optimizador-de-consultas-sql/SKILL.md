...
description: Este es un manual de optimización de SQL probado en combate que cubre el análisis de planes EXPLAIN, estrategias de indexación y patrones de reescritura de consultas para PostgreSQL y más allá. Te ayuda a convertir consultas lentas en otras ultrarrápidas, reducir la carga de la base de datos y diseñar esquemas que escalen con tus datos.
---
...
- **Runner:** `toolkit/phase-3-programming/optimizador-de-consultas-sql/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/optimizador-de-consultas-sql/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/optimizador-de-consultas-sql/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/optimizador-de-consultas-sql/tests/test_smoke.py`
