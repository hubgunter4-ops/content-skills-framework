---
name: plantilla-de-aplicacion-spark
description: Esta guía proporciona plantillas completas y con criterio, junto con las mejores prácticas para crear aplicaciones web modernas, paneles de control e interfaces interactivas. Recomienda una pila tecnológica completa, un sistema de diseño, una estructura de proyecto, convenciones de estilo y estándares de código para que puedas estructurar una aplicación hermosa y fácil de mantener, y poner en marcha un producto funcional rápidamente.
---

# Plantilla de Aplicación Spark

## Propósito
Esta guía proporciona plantillas completas y con criterio, junto con las mejores prácticas para crear aplicaciones web modernas, paneles de control e interfaces interactivas. Recomienda una pila tecnológica completa, un sistema de diseño, una estructura de proyecto, convenciones de estilo y estándares de código para que puedas estructurar una aplicación hermosa y fácil de mantener, y poner en marcha un producto funcional rápidamente.
...
- **Runner:** `toolkit/phase-3-programming/plantilla-de-aplicacion-spark/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/plantilla-de-aplicacion-spark/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/plantilla-de-aplicacion-spark/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/plantilla-de-aplicacion-spark/tests/test_smoke.py`
