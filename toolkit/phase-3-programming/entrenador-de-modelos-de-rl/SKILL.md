...
- **Runner:** `toolkit/phase-3-programming/entrenador-de-modelos-de-rl/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/entrenador-de-modelos-de-rl/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/entrenador-de-modelos-de-rl/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/entrenador-de-modelos-de-rl/tests/test_smoke.py`
