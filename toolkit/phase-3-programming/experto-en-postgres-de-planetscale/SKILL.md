...
- **Runner:** `toolkit/phase-3-programming/experto-en-postgres-de-planetscale/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/experto-en-postgres-de-planetscale/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/experto-en-postgres-de-planetscale/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/experto-en-postgres-de-planetscale/tests/test_smoke.py`
