---
name: quant-backtesting-pro
description: Esta guía del marco de trabajo para el backtesting de trading cuantitativo ayuda a los desarrolladores a construir sistemas fiables evitando errores comunes como el sesgo de anticipación look-ahead bias, el sesgo de supervivencia y el sobreajuste overfitting. Proporciona las mejores prácticas para gestionar el deslizamiento slippage y los costes de transacción, permitiéndole validar estrategias de trading de forma rigurosa antes de su implementación.
---

# Quant Backtesting Pro

## Propósito
Esta guía del marco de trabajo para el backtesting de trading cuantitativo ayuda a los desarrolladores a construir sistemas fiables evitando errores comunes como el sesgo de anticipación look-ahead bias, el sesgo de supervivencia y el sobreajuste overfitting. Proporciona las mejores prácticas para gestionar el deslizamiento slippage y los costes de transacción, permitiéndole validar estrategias de trading de forma rigurosa antes de su implementación.
...
- **Runner:** `toolkit/phase-3-programming/quant-backtesting-pro/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/quant-backtesting-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/quant-backtesting-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/quant-backtesting-pro/tests/test_smoke.py`
