...
- **Runner:** `toolkit/phase-3-programming/patrones-de-busqueda-vectorial/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/patrones-de-busqueda-vectorial/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/patrones-de-busqueda-vectorial/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/patrones-de-busqueda-vectorial/tests/test_smoke.py`
