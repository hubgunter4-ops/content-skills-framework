---
name: nucleo-de-animacion-gsap
description: Este kit de herramientas oficial de GSAP Core proporciona APIs de animación esenciales que incluyen gsap.to, from, fromTo, easing, duration, stagger y defaults. Ayuda a los desarrolladores a implementar rápidamente animaciones web fluidas y de alto rendimiento, reduciendo el esfuerzo de codificación manual y garantizando efectos de movimiento consistentes y profesionales en todos los proyectos web.
---

# Núcleo de Animación GSAP

## Propósito
Este kit de herramientas oficial de GSAP Core proporciona APIs de animación esenciales que incluyen gsap.to, from, fromTo, easing, duration, stagger y defaults. Ayuda a los desarrolladores a implementar rápidamente animaciones web fluidas y de alto rendimiento, reduciendo el esfuerzo de codificación manual y garantizando efectos de movimiento consistentes y profesionales en todos los proyectos web.
...
- **Runner:** `toolkit/phase-3-programming/nucleo-de-animacion-gsap/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/nucleo-de-animacion-gsap/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/nucleo-de-animacion-gsap/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/nucleo-de-animacion-gsap/tests/test_smoke.py`
