---
name: fotogramas-clave-de-hyperframes
description: Esta habilidad genera fotogramas clave y líneas de tiempo 2D y 3D seguros para la búsqueda para composiciones de HyperFrames, produciendo código para fotogramas clave CSS, GSAP, Anime.js, WAAPI, FLIP, morfismos SVG, máscaras y rastros de texto. Garantiza una reproducción precisa de los fotogramas, compatibilidad en tiempo de ejecución y proporciona diagnósticos y patrones de fotogramas clave correctivos para evitar vibraciones jitter durante el desplazamiento.
---

# Fotogramas clave de HyperFrames

## Propósito
Esta habilidad genera fotogramas clave y líneas de tiempo 2D y 3D seguros para la búsqueda para composiciones de HyperFrames, produciendo código para fotogramas clave CSS, GSAP, Anime.js, WAAPI, FLIP, morfismos SVG, máscaras y rastros de texto. Garantiza una reproducción precisa de los fotogramas, compatibilidad en tiempo de ejecución y proporciona diagnósticos y patrones de fotogramas clave correctivos para evitar vibraciones jitter durante el desplazamiento.
...
- **Runner:** `toolkit/phase-3-programming/fotogramas-clave-de-hyperframes/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/fotogramas-clave-de-hyperframes/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/fotogramas-clave-de-hyperframes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/fotogramas-clave-de-hyperframes/tests/test_smoke.py`
