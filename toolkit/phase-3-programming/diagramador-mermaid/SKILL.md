...
- **Runner:** `toolkit/phase-3-programming/diagramador-mermaid/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/diagramador-mermaid/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/diagramador-mermaid/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/diagramador-mermaid/tests/test_smoke.py`
