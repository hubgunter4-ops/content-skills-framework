---
name: busqueda-ia-de-mongodb
description: Esta integración oficial de MongoDB ayuda a los desarrolladores a implementar Atlas Search y recomendaciones impulsadas por IA mediante la búsqueda vectorial. Agiliza el proceso de configuración y prueba, lo que permite a los equipos integrar rápidamente capacidades de búsqueda avanzada en sus proyectos de backend existentes.
---

# Búsqueda & IA de MongoDB

## Propósito
Esta integración oficial de MongoDB ayuda a los desarrolladores a implementar Atlas Search y recomendaciones impulsadas por IA mediante la búsqueda vectorial. Agiliza el proceso de configuración y prueba, lo que permite a los equipos integrar rápidamente capacidades de búsqueda avanzada en sus proyectos de backend existentes.
...
- **Runner:** `toolkit/phase-3-programming/busqueda-ia-de-mongodb/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/busqueda-ia-de-mongodb/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/busqueda-ia-de-mongodb/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/busqueda-ia-de-mongodb/tests/test_smoke.py`
