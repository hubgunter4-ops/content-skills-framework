...
description: Esta habilidad codifica la filosofía de ingeniería de diseño de Emil Kowalski creador de Sonner y Vaul sobre el pulido de la interfaz de usuario, las decisiones de animación y los detalles invisibles. Te ayuda a decidir qué animar, elegir el suavizado y la duración adecuados, y crear componentes que se sientan receptivos y refinados.
---

# Ingeniería de Diseño de Emil

## Propósito
Esta habilidad codifica la filosofía de ingeniería de diseño de Emil Kowalski creador de Sonner y Vaul sobre el pulido de la interfaz de usuario, las decisiones de animación y los detalles invisibles. Te ayuda a decidir qué animar, elegir el suavizado y la duración adecuados, y crear componentes que se sientan receptivos y refinados.
...
- **Runner:** `toolkit/phase-3-programming/ingenieria-de-diseno-de-emil/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/ingenieria-de-diseno-de-emil/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/ingenieria-de-diseno-de-emil/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/ingenieria-de-diseno-de-emil/tests/test_smoke.py`
