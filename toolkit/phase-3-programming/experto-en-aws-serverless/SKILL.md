---
name: experto-en-aws-serverless
description: Construya, implemente y depure aplicaciones serverless de AWS con la experiencia oficial de AWS, que abarca Lambda, API Gateway, Step Functions, EventBridge y SAM/CDK. Obtenga cuotas exactas, reglas de concurrencia, estrategias de inicio en frío y tablas de resolución de problemas de error a corrección que transforman problemas serverless vagos en soluciones precisas y listas para producción.
---

# Experto en AWS Serverless

## Propósito
Construya, implemente y depure aplicaciones serverless de AWS con la experiencia oficial de AWS, que abarca Lambda, API Gateway, Step Functions, EventBridge y SAM/CDK. Obtenga cuotas exactas, reglas de concurrencia, estrategias de inicio en frío y tablas de resolución de problemas de error a corrección que transforman problemas serverless vagos en soluciones precisas y listas para producción.
...
- **Runner:** `toolkit/phase-3-programming/experto-en-aws-serverless/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/experto-en-aws-serverless/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/experto-en-aws-serverless/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/experto-en-aws-serverless/tests/test_smoke.py`
