...
description: Este conjunto de herramientas de rendimiento web ayuda a los desarrolladores a analizar la velocidad de carga, la eficiencia en tiempo de ejecución y la optimización de recursos. Identifica cuellos de botella y proporciona sugerencias específicas, ayudando a los equipos a crear páginas que cargan más rápido y experiencias interactivas más fluidas para los usuarios.
---

# Web Performance Pro

## Propósito
Este conjunto de herramientas de rendimiento web ayuda a los desarrolladores a analizar la velocidad de carga, la eficiencia en tiempo de ejecución y la optimización de recursos. Identifica cuellos de botella y proporciona sugerencias específicas, ayudando a los equipos a crear páginas que cargan más rápido y experiencias interactivas más fluidas para los usuarios.
...
- **Runner:** `toolkit/phase-3-programming/web-performance-pro/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/web-performance-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/web-performance-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/web-performance-pro/tests/test_smoke.py`
