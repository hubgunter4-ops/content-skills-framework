...
description: Esta colección oficial de complementos de GSAP proporciona herramientas de animación esenciales, incluyendo ScrollToPlugin, Flip, Draggable, SplitText, SVG y Physics. Extiende las capacidades principales de GreenSock, ayudando a los desarrolladores a crear animaciones web complejas y de alto rendimiento, así como experiencias interactivas con calidad y fiabilidad garantizadas.
---

# Suite de Animación GSAP

## Propósito
Esta colección oficial de complementos de GSAP proporciona herramientas de animación esenciales, incluyendo ScrollToPlugin, Flip, Draggable, SplitText, SVG y Physics. Extiende las capacidades principales de GreenSock, ayudando a los desarrolladores a crear animaciones web complejas y de alto rendimiento, así como experiencias interactivas con calidad y fiabilidad garantizadas.
...
- **Runner:** `toolkit/phase-3-programming/suite-de-animacion-gsap/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/suite-de-animacion-gsap/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/suite-de-animacion-gsap/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/suite-de-animacion-gsap/tests/test_smoke.py`
