...
description: Esta meta-habilidad aplica los principios del Desarrollo Guiado por Pruebas TDD a la creación, edición y verificación de Habilidades de Agente. Al requerir casos de prueba antes de redactar la documentación, ayuda a los desarrolladores y creadores a producir especificaciones de habilidades confiables y bien estructuradas, y garantiza que funcionen correctamente antes del despliegue.
---

# Arquitecto de Habilidades

## Propósito
Esta meta-habilidad aplica los principios del Desarrollo Guiado por Pruebas TDD a la creación, edición y verificación de Habilidades de Agente. Al requerir casos de prueba antes de redactar la documentación, ayuda a los desarrolladores y creadores a producir especificaciones de habilidades confiables y bien estructuradas, y garantiza que funcionen correctamente antes del despliegue.
...
- **Runner:** `toolkit/phase-3-programming/arquitecto-de-habilidades/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/arquitecto-de-habilidades/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/arquitecto-de-habilidades/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/arquitecto-de-habilidades/tests/test_smoke.py`
