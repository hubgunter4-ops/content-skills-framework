...
- **Runner:** `toolkit/phase-3-programming/patrones-de-transformacion-de-dbt/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/patrones-de-transformacion-de-dbt/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/patrones-de-transformacion-de-dbt/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/patrones-de-transformacion-de-dbt/tests/test_smoke.py`
