---
name: asistente-de-git-commit
description: Esta habilidad automatiza los commits de git analizando los diffs, detectando automáticamente el tipo y el alcance del commit convencional y generando mensajes de commit claros, al tiempo que ofrece anulaciones interactivas. Organiza inteligentemente los archivos en grupos lógicos para producir commits enfocados y consistentes que ahorran tiempo y mejoran la calidad del historial del repositorio para la CI y la colaboración.
---

# Asistente de Git Commit

## Propósito
Esta habilidad automatiza los commits de git analizando los diffs, detectando automáticamente el tipo y el alcance del commit convencional y generando mensajes de commit claros, al tiempo que ofrece anulaciones interactivas. Organiza inteligentemente los archivos en grupos lógicos para producir commits enfocados y consistentes que ahorran tiempo y mejoran la calidad del historial del repositorio para la CI y la colaboración.
...
- **Runner:** `toolkit/phase-3-programming/asistente-de-git-commit/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/asistente-de-git-commit/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/asistente-de-git-commit/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/asistente-de-git-commit/tests/test_smoke.py`
