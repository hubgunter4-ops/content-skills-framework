...
- **Runner:** `toolkit/phase-3-programming/patrones-de-busqueda-hibrida/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/patrones-de-busqueda-hibrida/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/patrones-de-busqueda-hibrida/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/patrones-de-busqueda-hibrida/tests/test_smoke.py`
