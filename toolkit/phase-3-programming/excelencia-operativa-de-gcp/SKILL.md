---
name: excelencia-operativa-de-gcp
description: Esta es una guía centrada en las operaciones para cargas de trabajo de Google Cloud basada en el pilar oficial de Excelencia Operativa. Ayuda a los arquitectos de la nube y a los ingenieros de operaciones a evaluar la salud arquitectónica, implementar una respuesta ante incidentes automatizada y crear entornos de nube más confiables y eficientes utilizando las mejores prácticas autorizadas.
---

# Excelencia Operativa de GCP

## Propósito
Esta es una guía centrada en las operaciones para cargas de trabajo de Google Cloud basada en el pilar oficial de Excelencia Operativa. Ayuda a los arquitectos de la nube y a los ingenieros de operaciones a evaluar la salud arquitectónica, implementar una respuesta ante incidentes automatizada y crear entornos de nube más confiables y eficientes utilizando las mejores prácticas autorizadas.
...
- **Runner:** `toolkit/phase-3-programming/excelencia-operativa-de-gcp/run.py`
- **Motor:** `toolkit/phase_3_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-3-programming/excelencia-operativa-de-gcp/input.example.json`
- **Esquema de salida:** `toolkit/phase-3-programming/excelencia-operativa-de-gcp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-3-programming/excelencia-operativa-de-gcp/tests/test_smoke.py`
