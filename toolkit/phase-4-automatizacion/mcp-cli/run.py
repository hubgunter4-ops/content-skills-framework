...
SKILL = {'name': 'MCP CLI', 'description': 'Proporciona una interfaz de línea de comandos para interactuar con servidores MCP y sus herramientas registradas. Úsela para descubrir servidores MCP disponibles y capacidades de herramientas, invocar herramientas respaldadas por MCP o APIs externas directamente desde su terminal o scripts.', 'slug': 'mcp-cli'}
def main() -> int:
