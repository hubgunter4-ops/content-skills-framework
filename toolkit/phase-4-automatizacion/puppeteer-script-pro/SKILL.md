---
name: puppeteer-script-pro
description: Genera scripts de Node.js Puppeteer para raspado web, capturas de pantalla automatizadas, generación de PDF y flujos de trabajo ligeros de sitios web. Traduce interacciones complejas del navegador en código ejecutable, ayudando a automatizar tareas repetitivas.
---

# Puppeteer Script Pro

## Propósito
Genera scripts de Node.js Puppeteer para raspado web, capturas de pantalla automatizadas, generación de PDF y flujos de trabajo ligeros de sitios web. Traduce interacciones complejas del navegador en código ejecutable, ayudando a automatizar tareas repetitivas.
...
- **Runner:** `toolkit/phase-4-automatizacion/puppeteer-script-pro/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/puppeteer-script-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/puppeteer-script-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/puppeteer-script-pro/tests/test_smoke.py`
