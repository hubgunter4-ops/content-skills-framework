...
SKILL = {'name': 'Grafana Dashboard Pro', 'description': 'Proporciona plantillas y mejores prácticas para crear tableros de Grafana listos para producción. Ayuda a construir rápidamente interfaces de visualización profesionales para métricas de sistemas y aplicaciones.', 'slug': 'grafana-dashboard-pro'}
def main() -> int:
