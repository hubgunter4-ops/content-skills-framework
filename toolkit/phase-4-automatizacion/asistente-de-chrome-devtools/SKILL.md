---
name: asistente-de-chrome-devtools
description: Proporciona automatización de navegación, depuración y análisis de rendimiento de nivel experto utilizando el protocolo Chrome DevTools. Interactúa con páginas web, captura capturas de pantalla y recopila perfiles de CPU y memoria.
---

# Asistente de Chrome DevTools

## Propósito
Proporciona automatización de navegación, depuración y análisis de rendimiento de nivel experto utilizando el protocolo Chrome DevTools. Interactúa con páginas web, captura capturas de pantalla y recopila perfiles de CPU y memoria.
...
- **Runner:** `toolkit/phase-4-automatizacion/asistente-de-chrome-devtools/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/asistente-de-chrome-devtools/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/asistente-de-chrome-devtools/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/asistente-de-chrome-devtools/tests/test_smoke.py`
