...
description: Guía centrada en las operaciones para cargas de trabajo de Google Cloud. Ayuda a evaluar la salud arquitectónica, implementar una respuesta ante incidentes automatizada y crear entornos de nube más confiables y eficientes.
---

# Excelencia Operativa de GCP

## Propósito
Guía centrada en las operaciones para cargas de trabajo de Google Cloud. Ayuda a evaluar la salud arquitectónica, implementar una respuesta ante incidentes automatizada y crear entornos de nube más confiables y eficientes.
...
- **Runner:** `toolkit/phase-4-automatizacion/excelencia-operativa-de-gcp/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/excelencia-operativa-de-gcp/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/excelencia-operativa-de-gcp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/excelencia-operativa-de-gcp/tests/test_smoke.py`
