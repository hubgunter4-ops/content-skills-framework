...
SKILL = {'name': 'Guía de desarrollo de agentes', 'description': 'Ayuda a diseñar, crear y documentar agentes autónomos y subagentes para los plugins de Claude Code. Recopila las mejores prácticas para garantizar un comportamiento del agente predecible, seguro y fácil de mantener.', 'slug': 'guia-de-desarrollo-de-agentes'}
def main() -> int:
