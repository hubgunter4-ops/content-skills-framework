---
name: guia-de-desarrollo-de-agentes
description: Ayuda a diseñar, crear y documentar agentes autónomos y subagentes para los plugins de Claude Code. Recopila las mejores prácticas para garantizar un comportamiento del agente predecible, seguro y fácil de mantener.
---

# Guía de desarrollo de agentes

## Propósito
Ayuda a diseñar, crear y documentar agentes autónomos y subagentes para los plugins de Claude Code. Recopila las mejores prácticas para garantizar un comportamiento del agente predecible, seguro y fácil de mantener.
...
- **Runner:** `toolkit/phase-4-automatizacion/guia-de-desarrollo-de-agentes/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/guia-de-desarrollo-de-agentes/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/guia-de-desarrollo-de-agentes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/guia-de-desarrollo-de-agentes/tests/test_smoke.py`
