...
description: Genera pruebas de Selenium WebDriver en los principales lenguajes de programación para tareas de automatización de navegadores. Ofrece un amplio soporte del ecosistema y portabilidad, ayudando a unificar las capacidades de automatización.
---

# Generador de Pruebas de Selenium

## Propósito
Genera pruebas de Selenium WebDriver en los principales lenguajes de programación para tareas de automatización de navegadores. Ofrece un amplio soporte del ecosistema y portabilidad, ayudando a unificar las capacidades de automatización.
...
- **Runner:** `toolkit/phase-4-automatizacion/generador-de-pruebas-de-selenium/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/generador-de-pruebas-de-selenium/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/generador-de-pruebas-de-selenium/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/generador-de-pruebas-de-selenium/tests/test_smoke.py`
