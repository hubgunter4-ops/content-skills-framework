---
name: buscador-de-habilidades-de-internet
description: Busca y recomienda habilidades de agente de repositorios verificados de GitHub para tareas y flujos de trabajo específicos.
---

# Buscador de Habilidades de Internet

## Propósito
Busca y recomienda habilidades de agente de repositorios verificados de GitHub para tareas y flujos de trabajo específicos.
...
- **Runner:** `toolkit/phase-4-automatizacion/buscador-de-habilidades-de-internet/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/buscador-de-habilidades-de-internet/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/buscador-de-habilidades-de-internet/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/buscador-de-habilidades-de-internet/tests/test_smoke.py`
