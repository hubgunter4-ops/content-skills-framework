---
name: configurador-de-nodos-n8n
description: Ayuda a configurar nodos de n8n con reglas de dependencia complejas y conexiones de IA. Agiliza la creación de flujos de trabajo automatizados gestionando dependencias de nodos intrincadas e integraciones de IA.
---

# Configurador de Nodos n8n

## Propósito
Ayuda a configurar nodos de n8n con reglas de dependencia complejas y conexiones de IA. Agiliza la creación de flujos de trabajo automatizados gestionando dependencias de nodos intrincadas e integraciones de IA.
...
- **Runner:** `toolkit/phase-4-automatizacion/configurador-de-nodos-n8n/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/configurador-de-nodos-n8n/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/configurador-de-nodos-n8n/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/configurador-de-nodos-n8n/tests/test_smoke.py`
