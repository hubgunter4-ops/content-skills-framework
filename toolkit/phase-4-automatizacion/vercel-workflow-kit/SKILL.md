...
description: Crea flujos de trabajo duraderos y reanudables utilizando el Workflow DevKit de Vercel. Permite que los procesos de varios pasos sobrevivan a reinicios, se pausen ante eventos externos y se reintenten en caso de error.
---

# Vercel Workflow Kit

## Propósito
Crea flujos de trabajo duraderos y reanudables utilizando el Workflow DevKit de Vercel. Permite que los procesos de varios pasos sobrevivan a reinicios, se pausen ante eventos externos y se reintenten en caso de error.
...
- **Runner:** `toolkit/phase-4-automatizacion/vercel-workflow-kit/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/vercel-workflow-kit/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/vercel-workflow-kit/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/vercel-workflow-kit/tests/test_smoke.py`
