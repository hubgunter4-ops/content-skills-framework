...
description: Descompone consultas y flujos de trabajo de búsqueda en múltiples fuentes para recuperar respuestas precisas. Divide preguntas en lenguaje natural en subconsultas específicas, las traduce a la sintaxis propia de cada fuente, clasifica y consolida los resultados por relevancia.
---

# Orquestador de Estrategias de Búsqueda

## Propósito
Descompone consultas y flujos de trabajo de búsqueda en múltiples fuentes para recuperar respuestas precisas. Divide preguntas en lenguaje natural en subconsultas específicas, las traduce a la sintaxis propia de cada fuente, clasifica y consolida los resultados por relevancia.
...
- **Runner:** `toolkit/phase-4-automatizacion/orquestador-de-estrategias-de-busqueda/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/orquestador-de-estrategias-de-busqueda/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/orquestador-de-estrategias-de-busqueda/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/orquestador-de-estrategias-de-busqueda/tests/test_smoke.py`
