...
SKILL = {'name': 'Orquestador de Estrategias de Búsqueda', 'description': 'Descompone consultas y flujos de trabajo de búsqueda en múltiples fuentes para recuperar respuestas precisas. Divide preguntas en lenguaje natural en subconsultas específicas, las traduce a la sintaxis propia de cada fuente, clasifica y consolida los resultados por relevancia.', 'slug': 'orquestador-de-estrategias-de-busqueda'}
def main() -> int:
