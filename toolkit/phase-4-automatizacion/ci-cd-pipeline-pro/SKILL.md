...
description: Guía de configuración de pipelines de CI/CD que proporciona prácticas estándar para automatizar las comprobaciones de calidad del código, los ejecutores de pruebas y las estrategias de despliegue. Convierte la compleja configuración de DevOps en un proceso estructurado.
---

# CI/CD Pipeline Pro

## Propósito
Guía de configuración de pipelines de CI/CD que proporciona prácticas estándar para automatizar las comprobaciones de calidad del código, los ejecutores de pruebas y las estrategias de despliegue. Convierte la compleja configuración de DevOps en un proceso estructurado.
...
- **Runner:** `toolkit/phase-4-automatizacion/ci-cd-pipeline-pro/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/ci-cd-pipeline-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/ci-cd-pipeline-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/ci-cd-pipeline-pro/tests/test_smoke.py`
