...
SKILL = {'name': 'Experto en n8n MCP', 'description': 'Guía a los desarrolladores a seleccionar y configurar herramientas y formatos de nodo del Protocolo de Contexto de Modelo MCP dentro de los flujos de trabajo de n8n. Proporciona orientación estructurada para integrar herramientas MCP.', 'slug': 'experto-en-n8n-mcp'}
def main() -> int:
