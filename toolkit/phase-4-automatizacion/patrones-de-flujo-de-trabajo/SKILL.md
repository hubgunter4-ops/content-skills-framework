---
name: patrones-de-flujo-de-trabajo
description: Proporciona una colección de patrones de flujo de trabajo de n8n que cubren webhooks, solicitudes HTTP, bases de datos y tareas de IA. Ofrece plantillas listas para usar, reduciendo el tiempo de configuración y garantizando una integración de datos confiable.
---

# Patrones de flujo de trabajo

## Propósito
Proporciona una colección de patrones de flujo de trabajo de n8n que cubren webhooks, solicitudes HTTP, bases de datos y tareas de IA. Ofrece plantillas listas para usar, reduciendo el tiempo de configuración y garantizando una integración de datos confiable.
...
- **Runner:** `toolkit/phase-4-automatizacion/patrones-de-flujo-de-trabajo/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/patrones-de-flujo-de-trabajo/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/patrones-de-flujo-de-trabajo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/patrones-de-flujo-de-trabajo/tests/test_smoke.py`
