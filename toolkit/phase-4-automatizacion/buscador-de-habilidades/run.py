...
SKILL = {'name': 'Buscador de habilidades', 'description': 'Descubre e instala habilidades de agentes desde el ecosistema de habilidades abiertas a través de la CLI de Skills. Encuentra rápidamente habilidades populares y probadas para cualquier tarea e instálalas con un solo comando.', 'slug': 'buscador-de-habilidades'}
def main() -> int:
