...
description: Ayuda a elegir el rol de Azure que otorga los permisos necesarios siguiendo los principios de privilegios mínimos. Proporciona instrucciones paso a paso para asignarlo a través del Portal, la CLI de Azure o plantillas ARM.
---

# Selector de roles de Azure

## Propósito
Ayuda a elegir el rol de Azure que otorga los permisos necesarios siguiendo los principios de privilegios mínimos. Proporciona instrucciones paso a paso para asignarlo a través del Portal, la CLI de Azure o plantillas ARM.
...
- **Runner:** `toolkit/phase-4-automatizacion/selector-de-roles-de-azure/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/selector-de-roles-de-azure/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/selector-de-roles-de-azure/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/selector-de-roles-de-azure/tests/test_smoke.py`
