...
SKILL = {'name': 'Selector de roles de Azure', 'description': 'Ayuda a elegir el rol de Azure que otorga los permisos necesarios siguiendo los principios de privilegios mínimos. Proporciona instrucciones paso a paso para asignarlo a través del Portal, la CLI de Azure o plantillas ARM.', 'slug': 'selector-de-roles-de-azure'}
def main() -> int:
