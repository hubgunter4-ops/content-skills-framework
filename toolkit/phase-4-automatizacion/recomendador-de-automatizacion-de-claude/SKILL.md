---
name: recomendador-de-automatizacion-de-claude
description: Analiza una base de código y recomienda automatizaciones de Claude Code adaptadas a la estructura y los objetivos de tu proyecto. Ayuda a priorizar e implementar automatizaciones con guías de configuración concretas.
---

# Recomendador de automatización de Claude

## Propósito
Analiza una base de código y recomienda automatizaciones de Claude Code adaptadas a la estructura y los objetivos de tu proyecto. Ayuda a priorizar e implementar automatizaciones con guías de configuración concretas.
...
- **Runner:** `toolkit/phase-4-automatizacion/recomendador-de-automatizacion-de-claude/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/recomendador-de-automatizacion-de-claude/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/recomendador-de-automatizacion-de-claude/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/recomendador-de-automatizacion-de-claude/tests/test_smoke.py`
