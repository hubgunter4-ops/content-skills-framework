...
SKILL = {'name': 'Recomendador de automatización de Claude', 'description': 'Analiza una base de código y recomienda automatizaciones de Claude Code adaptadas a la estructura y los objetivos de tu proyecto. Ayuda a priorizar e implementar automatizaciones con guías de configuración concretas.', 'slug': 'recomendador-de-automatizacion-de-claude'}
def main() -> int:
