...
description: Extrae datos de páginas y contenido de artículos, mediante extracción autorizada sin evadir controles anti-bot como Cloudflare. Ofrece un flujo de trabajo completo con selección inteligente de extractores y generación de scripts en Python.
---

# Extractor Web Inteligente

## Propósito
Extrae datos de páginas y contenido de artículos, mediante extracción autorizada sin evadir controles anti-bot como Cloudflare. Ofrece un flujo de trabajo completo con selección inteligente de extractores y generación de scripts en Python.
...
- **Runner:** `toolkit/phase-4-automatizacion/extractor-web-inteligente/run.py`
- **Motor:** `toolkit/phase_4_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-4-automatizacion/extractor-web-inteligente/input.example.json`
- **Esquema de salida:** `toolkit/phase-4-automatizacion/extractor-web-inteligente/output.schema.json`
- **Prueba smoke:** `toolkit/phase-4-automatizacion/extractor-web-inteligente/tests/test_smoke.py`
