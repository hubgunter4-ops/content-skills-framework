---
name: refactorizacion-de-markdown
...
- **Runner:** `toolkit/phase-1-content-toolkit/refactorizacion-de-markdown/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/refactorizacion-de-markdown/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/refactorizacion-de-markdown/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/refactorizacion-de-markdown/tests/test_smoke.py`
