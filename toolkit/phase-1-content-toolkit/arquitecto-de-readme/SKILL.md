---
name: arquitecto-de-readme
description: Este asistente de documentación proporciona plantillas profesionales de README y guías de escritura estructuradas adaptadas a diferentes tipos de proyectos y audiencias. Convierte detalles dispersos del proyecto en documentación clara y bien organizada, ayudando a los desarrolladores a crear READMEs específicos y profesionales, personales o internos.
---

# Arquitecto de README

## Propósito

Este asistente de documentación proporciona plantillas profesionales de README y guías de escritura estructuradas adaptadas a diferentes tipos de proyectos y audiencias. Convierte detalles dispersos del proyecto en documentación clara y bien organizada, ayudando a los desarrolladores a crear READMEs específicos y profesionales, personales o internos.
...
- **Runner:** `toolkit/phase-1-content-toolkit/arquitecto-de-readme/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/arquitecto-de-readme/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/arquitecto-de-readme/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/arquitecto-de-readme/tests/test_smoke.py`
