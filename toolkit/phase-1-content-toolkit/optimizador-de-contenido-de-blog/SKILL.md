...
- **Runner:** `toolkit/phase-1-content-toolkit/optimizador-de-contenido-de-blog/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/optimizador-de-contenido-de-blog/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/optimizador-de-contenido-de-blog/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/optimizador-de-contenido-de-blog/tests/test_smoke.py`
