...
- **Runner:** `toolkit/phase-1-content-toolkit/arquitecto-de-notas-de-obsidian/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/arquitecto-de-notas-de-obsidian/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/arquitecto-de-notas-de-obsidian/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/arquitecto-de-notas-de-obsidian/tests/test_smoke.py`
