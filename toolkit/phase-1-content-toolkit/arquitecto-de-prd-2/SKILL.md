...
Esta Skill es un asistente estructurado para redactar Documentos de Requisitos del Producto PRD, incorporando conocimientos de expertos en productos. Te guía desde la definición del problema hasta los criterios de éxito, haciendo que la planificación del producto sea más clara y ejecutable para los equipos de ingeniería.
...
- **Runner:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd-2/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd-2/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd-2/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd-2/tests/test_smoke.py`
