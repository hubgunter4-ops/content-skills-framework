---
name: analisis-de-brechas-de-contenido
description: . Identifica y prioriza las brechas de contenido del sitio web comparándolas con los competidores y la demanda de búsqueda utilizando Ahrefs, Semrush o datos públicos de las SERP.
---
...
. Identifica y prioriza las brechas de contenido del sitio web comparándolas con los competidores y la demanda de búsqueda utilizando Ahrefs, Semrush o datos públicos de las SERP.
...
- **Runner:** `toolkit/phase-1-content-toolkit/analisis-de-brechas-de-contenido/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/analisis-de-brechas-de-contenido/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/analisis-de-brechas-de-contenido/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/analisis-de-brechas-de-contenido/tests/test_smoke.py`
