...
- **Runner:** `toolkit/phase-1-content-toolkit/seguimiento-de-reuniones/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/seguimiento-de-reuniones/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/seguimiento-de-reuniones/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/seguimiento-de-reuniones/tests/test_smoke.py`
