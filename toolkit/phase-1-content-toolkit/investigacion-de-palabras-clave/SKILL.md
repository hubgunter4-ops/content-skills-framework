---
name: investigacion-de-palabras-clave
description: . Realice una investigación profesional de palabras.
---
...
. Realice una investigación profesional de palabras.
...
- **Runner:** `toolkit/phase-1-content-toolkit/investigacion-de-palabras-clave/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/investigacion-de-palabras-clave/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/investigacion-de-palabras-clave/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/investigacion-de-palabras-clave/tests/test_smoke.py`
