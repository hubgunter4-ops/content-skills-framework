---
name: estratega-de-contenidos-pro
description: Este kit de herramientas de marketing profesional le ayuda a planificar estrategias de contenido al decidir qué temas y formatos priorizar. Proporciona orientación práctica para diversos escenarios de marketing, permitiendo que los equipos alineen sus esfuerzos de contenido con los objetivos comerciales y ejecuten campañas de manera más efectiva.
---

# Estratega de Contenidos Pro

## Propósito

Este kit de herramientas de marketing profesional le ayuda a planificar estrategias de contenido al decidir qué temas y formatos priorizar. Proporciona orientación práctica para diversos escenarios de marketing, permitiendo que los equipos alineen sus esfuerzos de contenido con los objetivos comerciales y ejecuten campañas de manera más efectiva.
...
- **Runner:** `toolkit/phase-1-content-toolkit/estratega-de-contenidos-pro/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/estratega-de-contenidos-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/estratega-de-contenidos-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/estratega-de-contenidos-pro/tests/test_smoke.py`
