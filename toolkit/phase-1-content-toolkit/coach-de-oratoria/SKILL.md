---
name: coach-de-oratoria
description: Esta habilidad sintetiza las lecciones de oratoria de 12 invitados destacados del pódcast de Lenny en 10 marcos de trabajo prácticos, como los métodos del Arco y la Flecha y el Momento de 5 Segundos. Te ayuda a preparar charlas, perfeccionar la comunicación y transmitir ideas con confianza en cualquier escenario.
---
...
Esta habilidad sintetiza las lecciones de oratoria de 12 invitados destacados del pódcast de Lenny en 10 marcos de trabajo prácticos, como los métodos del Arco y la Flecha y el Momento de 5 Segundos. Te ayuda a preparar charlas, perfeccionar la comunicación y transmitir ideas con confianza en cualquier escenario.
...
- **Runner:** `toolkit/phase-1-content-toolkit/coach-de-oratoria/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/coach-de-oratoria/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/coach-de-oratoria/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/coach-de-oratoria/tests/test_smoke.py`
