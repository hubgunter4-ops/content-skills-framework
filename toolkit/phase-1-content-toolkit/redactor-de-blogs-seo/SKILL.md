---
name: redactor-de-blogs-seo
description: Este asistente de redacción de blogs genera artículos completos desde cero, incorporando imágenes, gráficos, preguntas frecuentes y enlaces internos, mientras optimiza para los rankings de Google y las citas de IA. Automatiza la estructuración y el formato del contenido, ayudando a creadores y especialistas en marketing a producir publicaciones de alta calidad y optimizadas para motores de búsqueda con mayor rapidez y sin trabajo de diseño manual.
---

# Redactor de Blogs SEO

## Propósito

Este asistente de redacción de blogs genera artículos completos desde cero, incorporando imágenes, gráficos, preguntas frecuentes y enlaces internos, mientras optimiza para los rankings de Google y las citas de IA. Automatiza la estructuración y el formato del contenido, ayudando a creadores y especialistas en marketing a producir publicaciones de alta calidad y optimizadas para motores de búsqueda con mayor rapidez y sin trabajo de diseño manual.
...
- **Runner:** `toolkit/phase-1-content-toolkit/redactor-de-blogs-seo/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/redactor-de-blogs-seo/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/redactor-de-blogs-seo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/redactor-de-blogs-seo/tests/test_smoke.py`
