...
Esta habilidad proporciona un generador de presentaciones basado en Marp con 7 temas integrados y guías de diseño detalladas. Transforma requisitos vagos o contenido sin procesar en código de diapositivas Markdown bien estructurado y con un formato atractivo, lo que lo hace ideal para crear rápidamente presentaciones técnicas profesionales o de negocios.
...
- **Runner:** `toolkit/phase-1-content-toolkit/generador-de-diapositivas-marp/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/generador-de-diapositivas-marp/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/generador-de-diapositivas-marp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/generador-de-diapositivas-marp/tests/test_smoke.py`
