...
Esta habilidad convierte texto, artículos o esquemas en archivos estructurados de Obsidian Canvas, admitiendo tanto mapas mentales como diseños espaciales de forma libre para la organización visual del conocimiento. Ayuda a los usuarios a convertir contenido lineal en lienzos visuales editables de forma más rápida, reduciendo el trabajo de disposición manual y facilitando la revisión y reorganización de ideas, estructuras de proyectos y relaciones.
...
- **Runner:** `toolkit/phase-1-content-toolkit/creador-de-obsidian-canvas/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/creador-de-obsidian-canvas/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/creador-de-obsidian-canvas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/creador-de-obsidian-canvas/tests/test_smoke.py`
