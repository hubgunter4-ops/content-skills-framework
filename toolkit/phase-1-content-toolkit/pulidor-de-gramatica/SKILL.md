...
- **Runner:** `toolkit/phase-1-content-toolkit/pulidor-de-gramatica/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/pulidor-de-gramatica/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/pulidor-de-gramatica/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/pulidor-de-gramatica/tests/test_smoke.py`
