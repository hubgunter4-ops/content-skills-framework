...
- **Runner:** `toolkit/phase-1-content-toolkit/adaptador-de-estilo-de-revista/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/adaptador-de-estilo-de-revista/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/adaptador-de-estilo-de-revista/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/adaptador-de-estilo-de-revista/tests/test_smoke.py`
