...
- **Runner:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/arquitecto-de-prd/tests/test_smoke.py`
