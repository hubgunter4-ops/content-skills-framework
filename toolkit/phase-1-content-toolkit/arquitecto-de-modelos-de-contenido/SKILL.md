...
- **Runner:** `toolkit/phase-1-content-toolkit/arquitecto-de-modelos-de-contenido/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/arquitecto-de-modelos-de-contenido/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/arquitecto-de-modelos-de-contenido/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/arquitecto-de-modelos-de-contenido/tests/test_smoke.py`
