...
- **Runner:** `toolkit/phase-1-content-toolkit/markdown-a-html/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/markdown-a-html/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/markdown-a-html/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/markdown-a-html/tests/test_smoke.py`
