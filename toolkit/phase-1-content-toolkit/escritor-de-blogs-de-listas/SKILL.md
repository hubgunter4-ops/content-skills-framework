---
name: escritor-de-blogs-de-listas
description: Redacte artículos de blog tipo listicle y publicaciones recopilatorias optimizados para SEO y GEO/AEO para posicionarse en los motores de búsqueda y obtener citas de motores de IA.
---

# Escritor de blogs de listas

## Propósito

Redacte artículos de blog tipo listicle y publicaciones recopilatorias optimizados para SEO y GEO/AEO para posicionarse en los motores de búsqueda y obtener citas de motores de IA.
...
- **Runner:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-listas/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-listas/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-listas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-listas/tests/test_smoke.py`
