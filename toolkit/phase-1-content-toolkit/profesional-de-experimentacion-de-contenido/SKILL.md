...
- **Runner:** `toolkit/phase-1-content-toolkit/profesional-de-experimentacion-de-contenido/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/profesional-de-experimentacion-de-contenido/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/profesional-de-experimentacion-de-contenido/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/profesional-de-experimentacion-de-contenido/tests/test_smoke.py`
