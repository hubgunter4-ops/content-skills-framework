...
Esta herramienta aplica automáticamente su imagen de marca corporativa —colores, fuentes, diseños y mensajes— a documentos y plantillas generados por IA para garantizar una identidad visual coherente. Acelera la producción al aplicar reglas de estilo en hojas de una página, presentaciones, correos electrónicos y otros materiales para que cada activo coincida con sus directrices de marca.
...
- **Runner:** `toolkit/phase-1-content-toolkit/motor-de-estilo-de-marca/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/motor-de-estilo-de-marca/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/motor-de-estilo-de-marca/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/motor-de-estilo-de-marca/tests/test_smoke.py`
