---
name: optimizador-de-seo-para-ia
...
- **Runner:** `toolkit/phase-1-content-toolkit/optimizador-de-seo-para-ia/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/optimizador-de-seo-para-ia/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/optimizador-de-seo-para-ia/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/optimizador-de-seo-para-ia/tests/test_smoke.py`
