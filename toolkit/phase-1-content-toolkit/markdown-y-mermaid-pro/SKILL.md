...
Esta habilidad proporciona pautas y plantillas de escritura de Markdown y Mermaid para crear documentos técnicos, diagramas de arquitectura e informes de investigación. Establece los diagramas basados en texto como el estándar de documentación predeterminado, ayudándole a generar documentos y visualizaciones estandarizados con un formato consistente.
...
- **Runner:** `toolkit/phase-1-content-toolkit/markdown-y-mermaid-pro/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/markdown-y-mermaid-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/markdown-y-mermaid-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/markdown-y-mermaid-pro/tests/test_smoke.py`
