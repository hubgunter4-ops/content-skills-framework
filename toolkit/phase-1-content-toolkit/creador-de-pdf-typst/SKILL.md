---
name: creador-de-pdf-typst
description: Genera documentos PDF profesionales y de alta calidad utilizando Typst con tipografía precisa, fórmulas matemáticas y resaltado de código.
---

# Creador de PDF Typst

## Propósito

Genera documentos PDF profesionales y de alta calidad utilizando Typst con tipografía precisa, fórmulas matemáticas y resaltado de código.
...
- **Runner:** `toolkit/phase-1-content-toolkit/creador-de-pdf-typst/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/creador-de-pdf-typst/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/creador-de-pdf-typst/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/creador-de-pdf-typst/tests/test_smoke.py`
