---
name: estratega-de-seo-y-aeo
description: Esta guía de mejores prácticas para sitios web de contenido cubre tanto la Optimización de Motores de Búsqueda SEO tradicional como la Optimización de Motores de Respuesta AEO. Proporciona patrones accionables para ayudar a que su contenido se posicione mejor en los resultados de búsqueda estándar, al tiempo que garantiza que sea fácilmente detectable y citado con precisión por los motores de respuesta impulsados por IA.
---

# Estratega de SEO & AEO

## Propósito

Esta guía de mejores prácticas para sitios web de contenido cubre tanto la Optimización de Motores de Búsqueda SEO tradicional como la Optimización de Motores de Respuesta AEO. Proporciona patrones accionables para ayudar a que su contenido se posicione mejor en los resultados de búsqueda estándar, al tiempo que garantiza que sea fácilmente detectable y citado con precisión por los motores de respuesta impulsados por IA.
...
- **Runner:** `toolkit/phase-1-content-toolkit/estratega-de-seo-y-aeo/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/estratega-de-seo-y-aeo/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/estratega-de-seo-y-aeo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/estratega-de-seo-y-aeo/tests/test_smoke.py`
