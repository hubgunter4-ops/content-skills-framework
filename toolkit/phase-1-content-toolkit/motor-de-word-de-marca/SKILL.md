...
Este motor de Word con reconocimiento de marca extrae pautas de diseño como fuentes, colores y estilos de plantillas existentes para crear un perfil de marca reutilizable. Al automatizar la generación de nuevos documentos .docx basados en estos perfiles guardados, garantiza una identidad corporativa coherente en todos los resultados y elimina el formato manual repetitivo.
...
- **Runner:** `toolkit/phase-1-content-toolkit/motor-de-word-de-marca/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/motor-de-word-de-marca/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/motor-de-word-de-marca/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/motor-de-word-de-marca/tests/test_smoke.py`
