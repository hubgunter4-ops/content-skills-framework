...
- **Runner:** `toolkit/phase-1-content-toolkit/creador-de-contenido-multicanal/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/creador-de-contenido-multicanal/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/creador-de-contenido-multicanal/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/creador-de-contenido-multicanal/tests/test_smoke.py`
