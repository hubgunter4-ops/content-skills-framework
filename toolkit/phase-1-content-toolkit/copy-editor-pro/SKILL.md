...
Esta herramienta de edición de textos de marketing te ayuda a perfeccionar y mejorar textos existentes para lograr una mayor claridad e impacto en diversas campañas. Agiliza el proceso de revisión, asegurando que tu mensaje sea persuasivo y coherente sin necesidad de una reescritura exhaustiva.
...
- **Runner:** `toolkit/phase-1-content-toolkit/copy-editor-pro/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/copy-editor-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/copy-editor-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/copy-editor-pro/tests/test_smoke.py`
