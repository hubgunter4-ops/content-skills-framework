---
name: escritor-de-blogs-de-alternativas
description: Escribe artículos de blog de comparación de competidores y alternativas optimizados para SEO para captar tráfico de búsqueda orgánica.
---

# Escritor de blogs de alternativas

## Propósito

Escribe artículos de blog de comparación de competidores y alternativas optimizados para SEO para captar tráfico de búsqueda orgánica.
...
- **Runner:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-alternativas/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-alternativas/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-alternativas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/escritor-de-blogs-de-alternativas/tests/test_smoke.py`
