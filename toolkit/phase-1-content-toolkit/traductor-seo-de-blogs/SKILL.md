---
name: traductor-seo-de-blogs
description: Esta es una herramienta profesional de traducción de blogs y localización SEO que traduce publicaciones a múltiples idiomas manteniendo la estructura de markdown, los metadatos y los archivos multimedia incrustados. Localiza automáticamente las palabras clave y el formato para el público objetivo, ayudando a los creadores de contenido a expandirse globalmente sin la molestia de reformatear manualmente o perder valor SEO.
---

# Traductor SEO de Blogs

## Propósito

Esta es una herramienta profesional de traducción de blogs y localización SEO que traduce publicaciones a múltiples idiomas manteniendo la estructura de markdown, los metadatos y los archivos multimedia incrustados. Localiza automáticamente las palabras clave y el formato para el público objetivo, ayudando a los creadores de contenido a expandirse globalmente sin la molestia de reformatear manualmente o perder valor SEO.
...
- **Runner:** `toolkit/phase-1-content-toolkit/traductor-seo-de-blogs/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/traductor-seo-de-blogs/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/traductor-seo-de-blogs/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/traductor-seo-de-blogs/tests/test_smoke.py`
