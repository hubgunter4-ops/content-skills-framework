...
description: Esta herramienta sintetiza los resultados de búsqueda de múltiples fuentes en respuestas coherentes y sin duplicados, con una clara atribución de fuentes y puntuación de confianza. Pondera la actualidad y la autoridad para mostrar la información más fiable y comprime grandes conjuntos de resultados en resúmenes concisos y prácticos para informes, agentes o sesiones informativas para las partes interesadas.
---
...
Esta herramienta sintetiza los resultados de búsqueda de múltiples fuentes en respuestas coherentes y sin duplicados, con una clara atribución de fuentes y puntuación de confianza. Pondera la actualidad y la autoridad para mostrar la información más fiable y comprime grandes conjuntos de resultados en resúmenes concisos y prácticos para informes, agentes o sesiones informativas para las partes interesadas.
...
- **Runner:** `toolkit/phase-1-content-toolkit/sintetizador-de-conocimiento/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/sintetizador-de-conocimiento/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/sintetizador-de-conocimiento/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/sintetizador-de-conocimiento/tests/test_smoke.py`
