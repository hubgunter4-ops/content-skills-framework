---
name: analisis-de-competidores-seo
description: Cree informes simplificados de competidores orgánicos de SEO centrados en los objetivos, modelados según el estilo de informe aprobado de hix.ai, con gráficos de apoyo y prioridades a 90 días.
---
...
Cree informes simplificados de competidores orgánicos de SEO centrados en los objetivos, modelados según el estilo de informe aprobado de hix.ai, con gráficos de apoyo y prioridades a 90 días.
...
- **Runner:** `toolkit/phase-1-content-toolkit/analisis-de-competidores-seo/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/analisis-de-competidores-seo/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/analisis-de-competidores-seo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/analisis-de-competidores-seo/tests/test_smoke.py`
