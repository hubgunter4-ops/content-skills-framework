---
name: generador-de-informes-de-auditoria-seo
description: Cree informes de auditoría SEO en lenguaje sencillo y basados en pruebas, con resúmenes ejecutivos estructurados y listas de correcciones priorizadas basadas estrictamente en los datos del informe.
---

# Generador de informes de auditoría SEO

## Propósito

Cree informes de auditoría SEO en lenguaje sencillo y basados en pruebas, con resúmenes ejecutivos estructurados y listas de correcciones priorizadas basadas estrictamente en los datos del informe.
...
- **Runner:** `toolkit/phase-1-content-toolkit/generador-de-informes-de-auditoria-seo/run.py`
- **Motor:** `toolkit/skill_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-1-content-toolkit/generador-de-informes-de-auditoria-seo/input.example.json`
- **Esquema de salida:** `toolkit/phase-1-content-toolkit/generador-de-informes-de-auditoria-seo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-1-content-toolkit/generador-de-informes-de-auditoria-seo/tests/test_smoke.py`
