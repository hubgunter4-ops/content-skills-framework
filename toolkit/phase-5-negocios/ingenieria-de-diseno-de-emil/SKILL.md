---
name: ingenieria-de-diseno-de-emil
description: Codifica la filosofía de ingeniería de diseño de Emil Kowalski sobre el pulido de la interfaz de usuario, las decisiones de animación y los detalles invisibles. Ayuda a decidir qué animar, elegir el suavizado y la duración adecuados, y crear componentes que se sientan receptivos y refinados.
---

# Ingeniería de Diseño de Emil

## Propósito
Codifica la filosofía de ingeniería de diseño de Emil Kowalski sobre el pulido de la interfaz de usuario, las decisiones de animación y los detalles invisibles. Ayuda a decidir qué animar, elegir el suavizado y la duración adecuados, y crear componentes que se sientan receptivos y refinados.
...
- **Runner:** `toolkit/phase-5-negocios/ingenieria-de-diseno-de-emil/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/ingenieria-de-diseno-de-emil/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/ingenieria-de-diseno-de-emil/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/ingenieria-de-diseno-de-emil/tests/test_smoke.py`
