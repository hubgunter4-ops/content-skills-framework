...
SKILL = {'name': 'Ingeniería de Diseño de Emil', 'description': 'Codifica la filosofía de ingeniería de diseño de Emil Kowalski sobre el pulido de la interfaz de usuario, las decisiones de animación y los detalles invisibles. Ayuda a decidir qué animar, elegir el suavizado y la duración adecuados, y crear componentes que se sientan receptivos y refinados.', 'slug': 'ingenieria-de-diseno-de-emil'}
def main() -> int:
