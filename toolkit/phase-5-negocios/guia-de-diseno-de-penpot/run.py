...
SKILL = {'name': 'Guía de diseño de Penpot', 'description': 'Proporciona un flujo de trabajo integral para crear diseños de UI/UX profesionales en Penpot utilizando herramientas MCP. Ayuda a los diseñadores a crear interfaces adaptables, sistemas de diseño y patrones accesibles más rápido.', 'slug': 'guia-de-diseno-de-penpot'}
def main() -> int:
