---
name: guia-de-diseno-de-penpot
description: Proporciona un flujo de trabajo integral para crear diseños de UI/UX profesionales en Penpot utilizando herramientas MCP. Ayuda a los diseñadores a crear interfaces adaptables, sistemas de diseño y patrones accesibles más rápido.
---

# Guía de diseño de Penpot

## Propósito
Proporciona un flujo de trabajo integral para crear diseños de UI/UX profesionales en Penpot utilizando herramientas MCP. Ayuda a los diseñadores a crear interfaces adaptables, sistemas de diseño y patrones accesibles más rápido.
...
- **Runner:** `toolkit/phase-5-negocios/guia-de-diseno-de-penpot/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/guia-de-diseno-de-penpot/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/guia-de-diseno-de-penpot/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/guia-de-diseno-de-penpot/tests/test_smoke.py`
