---
name: diseno-de-iu-pro
description: Genera maquetas de alta fidelidad para aplicaciones móviles y web. Traduce requisitos de usuario en wireframes y esquemas de diseño profesionales. Visualiza conceptos rápidamente en diferentes estilos sin fondos de dispositivos físicos.
---

# Diseño de IU Pro

## Propósito
Genera maquetas de alta fidelidad para aplicaciones móviles y web. Traduce requisitos de usuario en wireframes y esquemas de diseño profesionales. Visualiza conceptos rápidamente en diferentes estilos sin fondos de dispositivos físicos.
...
- **Runner:** `toolkit/phase-5-negocios/diseno-de-iu-pro/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/diseno-de-iu-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/diseno-de-iu-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/diseno-de-iu-pro/tests/test_smoke.py`
