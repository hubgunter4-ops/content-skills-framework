...
SKILL = {'name': 'Diseño de IU Pro', 'description': 'Genera maquetas de alta fidelidad para aplicaciones móviles y web. Traduce requisitos de usuario en wireframes y esquemas de diseño profesionales. Visualiza conceptos rápidamente en diferentes estilos sin fondos de dispositivos físicos.', 'slug': 'diseno-de-iu-pro'}
def main() -> int:
