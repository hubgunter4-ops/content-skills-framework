...
SKILL = {'name': 'Auditoría de accesibilidad', 'description': 'Verifica el contraste de color, la navegación por teclado, los objetivos táctiles y el comportamiento del lector de pantalla. Entrega un informe de hallazgos estructurado con correcciones priorizadas.', 'slug': 'auditoria-de-accesibilidad'}
def main() -> int:
