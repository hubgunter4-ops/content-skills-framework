---
name: auditoria-de-accesibilidad
description: Verifica el contraste de color, la navegación por teclado, los objetivos táctiles y el comportamiento del lector de pantalla. Entrega un informe de hallazgos estructurado con correcciones priorizadas.
---

# Auditoría de accesibilidad

## Propósito
Verifica el contraste de color, la navegación por teclado, los objetivos táctiles y el comportamiento del lector de pantalla. Entrega un informe de hallazgos estructurado con correcciones priorizadas.
...
- **Runner:** `toolkit/phase-5-negocios/auditoria-de-accesibilidad/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/auditoria-de-accesibilidad/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/auditoria-de-accesibilidad/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/auditoria-de-accesibilidad/tests/test_smoke.py`
