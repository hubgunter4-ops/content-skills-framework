...
description: Ayuda a los usuarios a crear diagramas de flujo, diagramas de secuencia, diagramas ER y visualizaciones de arquitectura a partir de instrucciones estructuradas o material de origen. Convierte sistemas complejos, modelos de datos y flujos de negocio en visualizaciones claras.
---

# Diagramador Mermaid

## Propósito
Ayuda a los usuarios a crear diagramas de flujo, diagramas de secuencia, diagramas ER y visualizaciones de arquitectura a partir de instrucciones estructuradas o material de origen. Convierte sistemas complejos, modelos de datos y flujos de negocio en visualizaciones claras.
...
- **Runner:** `toolkit/phase-5-negocios/diagramador-mermaid/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/diagramador-mermaid/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/diagramador-mermaid/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/diagramador-mermaid/tests/test_smoke.py`
