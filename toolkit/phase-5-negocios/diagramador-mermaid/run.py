...
SKILL = {'name': 'Diagramador Mermaid', 'description': 'Ayuda a los usuarios a crear diagramas de flujo, diagramas de secuencia, diagramas ER y visualizaciones de arquitectura a partir de instrucciones estructuradas o material de origen. Convierte sistemas complejos, modelos de datos y flujos de negocio en visualizaciones claras.', 'slug': 'diagramador-mermaid'}
def main() -> int:
