...
description: Manual del sistema de diseño de Tailwind CSS v4. Cubre la configuración CSS-first, tokens de diseño OKLCH, modo oscuro y arquitectura de variantes de componentes. Ayuda a construir bibliotecas de componentes consistentes y accesibles.
---

# Sistema de diseño de Tailwind

## Propósito
Manual del sistema de diseño de Tailwind CSS v4. Cubre la configuración CSS-first, tokens de diseño OKLCH, modo oscuro y arquitectura de variantes de componentes. Ayuda a construir bibliotecas de componentes consistentes y accesibles.
...
- **Runner:** `toolkit/phase-5-negocios/sistema-de-diseno-de-tailwind/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/sistema-de-diseno-de-tailwind/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/sistema-de-diseno-de-tailwind/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/sistema-de-diseno-de-tailwind/tests/test_smoke.py`
