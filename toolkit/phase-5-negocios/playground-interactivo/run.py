...
SKILL = {'name': 'Playground Interactivo', 'description': 'Crea entornos de pruebas HTML interactivos e independientes. Permite a los usuarios configurar opciones mediante controles visuales, ver una vista previa en vivo y copiar el prompt o marcado resultante. Produce un explorador de archivo único adecuado para compartir o incrustar.', 'slug': 'playground-interactivo'}
def main() -> int:
