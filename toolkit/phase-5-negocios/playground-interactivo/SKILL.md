...
description: Crea entornos de pruebas HTML interactivos e independientes. Permite a los usuarios configurar opciones mediante controles visuales, ver una vista previa en vivo y copiar el prompt o marcado resultante. Produce un explorador de archivo único adecuado para compartir o incrustar.
---

# Playground Interactivo

## Propósito
Crea entornos de pruebas HTML interactivos e independientes. Permite a los usuarios configurar opciones mediante controles visuales, ver una vista previa en vivo y copiar el prompt o marcado resultante. Produce un explorador de archivo único adecuado para compartir o incrustar.
...
- **Runner:** `toolkit/phase-5-negocios/playground-interactivo/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/playground-interactivo/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/playground-interactivo/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/playground-interactivo/tests/test_smoke.py`
