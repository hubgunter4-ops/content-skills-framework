...
SKILL = {'name': 'Generador de favicons', 'description': 'Genera un conjunto completo de favicons para sitios web a partir de logotipos, texto o formas de marca. Produce automáticamente todos los formatos y el código HTML necesarios, asegurando que su sitio se vea profesional en todos los dispositivos y navegadores.', 'slug': 'generador-de-favicons'}
def main() -> int:
