...
description: Genera un conjunto completo de favicons para sitios web a partir de logotipos, texto o formas de marca. Produce automáticamente todos los formatos y el código HTML necesarios, asegurando que su sitio se vea profesional en todos los dispositivos y navegadores.
---

# Generador de favicons

## Propósito
Genera un conjunto completo de favicons para sitios web a partir de logotipos, texto o formas de marca. Produce automáticamente todos los formatos y el código HTML necesarios, asegurando que su sitio se vea profesional en todos los dispositivos y navegadores.
...
- **Runner:** `toolkit/phase-5-negocios/generador-de-favicons/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/generador-de-favicons/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/generador-de-favicons/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/generador-de-favicons/tests/test_smoke.py`
