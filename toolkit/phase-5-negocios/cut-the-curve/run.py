...
SKILL = {'name': 'Cut the Curve', 'description': 'Cataloga la familia de técnicas de costura de movimiento Cut the Curve para transiciones cinematográficas y texto cinético. Proporciona parámetros accionables, recetas de suavizado, reglas de escala Z, pautas de tamaño de desenfoque, proporciones de ritmo y plantillas de código GSAP.', 'slug': 'cut-the-curve'}
def main() -> int:
