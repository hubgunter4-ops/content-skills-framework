...
SKILL = {'name': 'Extractor de sistemas de diseño', 'description': 'Realiza ingeniería inversa de un sistema de diseño completo directamente desde el código fuente del frontend. Captura colores, tipografía, espaciado y patrones de componentes sin compilar ni ejecutar la aplicación.', 'slug': 'extractor-de-sistemas-de-diseno'}
def main() -> int:
