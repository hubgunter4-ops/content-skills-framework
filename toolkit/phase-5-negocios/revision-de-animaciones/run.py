...
SKILL = {'name': 'Revisión de Animaciones', 'description': 'Audita el código de movimiento según diez estándares de artesanía no negociables. Verifica suavizado, duración, origen, interrumpibilidad, rendimiento y accesibilidad para que cada animación se sienta bien, no solo funcione.', 'slug': 'revision-de-animaciones'}
def main() -> int:
