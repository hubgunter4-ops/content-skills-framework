---
name: revision-de-animaciones
description: Audita el código de movimiento según diez estándares de artesanía no negociables. Verifica suavizado, duración, origen, interrumpibilidad, rendimiento y accesibilidad para que cada animación se sienta bien, no solo funcione.
---

# Revisión de Animaciones

## Propósito
Audita el código de movimiento según diez estándares de artesanía no negociables. Verifica suavizado, duración, origen, interrumpibilidad, rendimiento y accesibilidad para que cada animación se sienta bien, no solo funcione.
...
- **Runner:** `toolkit/phase-5-negocios/revision-de-animaciones/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/revision-de-animaciones/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/revision-de-animaciones/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/revision-de-animaciones/tests/test_smoke.py`
