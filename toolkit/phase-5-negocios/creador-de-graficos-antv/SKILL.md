...
description: Ofrece más de 26 tipos de gráficos, desde gráficos de barras y líneas hasta diagramas de Sankey, mapas mentales y nubes de palabras. Selecciona el mejor gráfico para sus datos y devuelve una imagen del gráfico lista para compartir a través de la API de AntV en segundos.
---

# Creador de gráficos AntV

## Propósito
Ofrece más de 26 tipos de gráficos, desde gráficos de barras y líneas hasta diagramas de Sankey, mapas mentales y nubes de palabras. Selecciona el mejor gráfico para sus datos y devuelve una imagen del gráfico lista para compartir a través de la API de AntV en segundos.
...
- **Runner:** `toolkit/phase-5-negocios/creador-de-graficos-antv/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/creador-de-graficos-antv/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/creador-de-graficos-antv/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/creador-de-graficos-antv/tests/test_smoke.py`
