...
SKILL = {'name': 'Markdown & Mermaid Pro', 'description': 'Proporciona pautas y plantillas de escritura de Markdown y Mermaid para crear documentos técnicos, diagramas de arquitectura e informes de investigación. Establece los diagramas basados en texto como el estándar de documentación predeterminado.', 'slug': 'markdown-mermaid-pro'}
def main() -> int:
