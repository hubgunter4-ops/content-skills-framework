---
name: markdown-mermaid-pro
description: Proporciona pautas y plantillas de escritura de Markdown y Mermaid para crear documentos técnicos, diagramas de arquitectura e informes de investigación. Establece los diagramas basados en texto como el estándar de documentación predeterminado.
---

# Markdown & Mermaid Pro

## Propósito
Proporciona pautas y plantillas de escritura de Markdown y Mermaid para crear documentos técnicos, diagramas de arquitectura e informes de investigación. Establece los diagramas basados en texto como el estándar de documentación predeterminado.
...
- **Runner:** `toolkit/phase-5-negocios/markdown-mermaid-pro/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/markdown-mermaid-pro/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/markdown-mermaid-pro/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/markdown-mermaid-pro/tests/test_smoke.py`
