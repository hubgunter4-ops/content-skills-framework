---
name: motor-de-estilo-de-marca
description: Aplica automáticamente la imagen de marca corporativa a documentos y plantillas generados por IA. Garantiza una identidad visual coherente en hojas de una página, presentaciones, correos electrónicos y otros materiales.
---

# Motor de Estilo de Marca

## Propósito
Aplica automáticamente la imagen de marca corporativa a documentos y plantillas generados por IA. Garantiza una identidad visual coherente en hojas de una página, presentaciones, correos electrónicos y otros materiales.
...
- **Runner:** `toolkit/phase-5-negocios/motor-de-estilo-de-marca/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/motor-de-estilo-de-marca/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/motor-de-estilo-de-marca/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/motor-de-estilo-de-marca/tests/test_smoke.py`
