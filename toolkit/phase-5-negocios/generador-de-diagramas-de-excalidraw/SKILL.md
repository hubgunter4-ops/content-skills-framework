...
description: Genera diagramas de Excalidraw a partir de descripciones en lenguaje natural. Admite diagramas de flujo, diagramas de relaciones, mapas mentales y representaciones visuales de arquitectura de sistemas.
---

# Generador de diagramas de Excalidraw

## Propósito
Genera diagramas de Excalidraw a partir de descripciones en lenguaje natural. Admite diagramas de flujo, diagramas de relaciones, mapas mentales y representaciones visuales de arquitectura de sistemas.
...
- **Runner:** `toolkit/phase-5-negocios/generador-de-diagramas-de-excalidraw/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/generador-de-diagramas-de-excalidraw/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/generador-de-diagramas-de-excalidraw/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/generador-de-diagramas-de-excalidraw/tests/test_smoke.py`
