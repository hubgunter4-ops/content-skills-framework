...
SKILL = {'name': 'Generador de diagramas de Excalidraw', 'description': 'Genera diagramas de Excalidraw a partir de descripciones en lenguaje natural. Admite diagramas de flujo, diagramas de relaciones, mapas mentales y representaciones visuales de arquitectura de sistemas.', 'slug': 'generador-de-diagramas-de-excalidraw'}
def main() -> int:
