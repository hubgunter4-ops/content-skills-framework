...
SKILL = {'name': 'Paleta de colores inteligente', 'description': 'Genera una paleta de colores accesible completa a partir de un único color de marca. Incluye escalas de 11 pasos, tokens semánticos, variantes de modo oscuro, CSS para Tailwind v4 y comprobaciones de contraste WCAG.', 'slug': 'paleta-de-colores-inteligente'}
def main() -> int:
