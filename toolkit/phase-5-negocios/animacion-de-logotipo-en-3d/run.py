...
SKILL = {'name': 'Animación de logotipo en 3D', 'description': 'Convierte logotipos 2D en animaciones 3D con materiales dimensionales, iluminación cinematográfica y movimiento de cámara. Ideal para intros de video, sitios web y redes sociales. Combina edición de imágenes y generación de video en un solo flujo de trabajo.', 'slug': 'animacion-de-logotipo-en-3d'}
def main() -> int:
