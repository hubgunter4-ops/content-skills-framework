---
name: animacion-de-logotipo-en-3d
description: Convierte logotipos 2D en animaciones 3D con materiales dimensionales, iluminación cinematográfica y movimiento de cámara. Ideal para intros de video, sitios web y redes sociales. Combina edición de imágenes y generación de video en un solo flujo de trabajo.
---

# Animación de logotipo en 3D

## Propósito
Convierte logotipos 2D en animaciones 3D con materiales dimensionales, iluminación cinematográfica y movimiento de cámara. Ideal para intros de video, sitios web y redes sociales. Combina edición de imágenes y generación de video en un solo flujo de trabajo.
...
- **Runner:** `toolkit/phase-5-negocios/animacion-de-logotipo-en-3d/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/animacion-de-logotipo-en-3d/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/animacion-de-logotipo-en-3d/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/animacion-de-logotipo-en-3d/tests/test_smoke.py`
