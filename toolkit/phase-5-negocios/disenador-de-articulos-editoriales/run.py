...
SKILL = {'name': 'Diseñador de artículos editoriales', 'description': 'Transforma cualquier material de origen en un hermoso artículo HTML de un solo archivo con componentes interactivos. Garantiza la retención del 100% de la información mientras ofrece una experiencia de lectura pulida y lista para compartir.', 'slug': 'disenador-de-articulos-editoriales'}
def main() -> int:
