---
name: motor-de-word-de-marca
description: Extrae pautas de diseño como fuentes, colores y estilos de plantillas existentes para crear un perfil de marca reutilizable. Automatiza la generación de nuevos documentos .docx basados en estos perfiles guardados, garantizando una identidad corporativa coherente.
---

# Motor de Word de Marca

## Propósito
Extrae pautas de diseño como fuentes, colores y estilos de plantillas existentes para crear un perfil de marca reutilizable. Automatiza la generación de nuevos documentos .docx basados en estos perfiles guardados, garantizando una identidad corporativa coherente.
...
- **Runner:** `toolkit/phase-5-negocios/motor-de-word-de-marca/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/motor-de-word-de-marca/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/motor-de-word-de-marca/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/motor-de-word-de-marca/tests/test_smoke.py`
