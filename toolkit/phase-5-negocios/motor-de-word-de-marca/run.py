...
SKILL = {'name': 'Motor de Word de Marca', 'description': 'Extrae pautas de diseño como fuentes, colores y estilos de plantillas existentes para crear un perfil de marca reutilizable. Automatiza la generación de nuevos documentos .docx basados en estos perfiles guardados, garantizando una identidad corporativa coherente.', 'slug': 'motor-de-word-de-marca'}
def main() -> int:
