...
SKILL = {'name': 'Revisor de Diseño Web', 'description': 'Permite la inspección visual de sitios web para identificar y corregir problemas de diseño a nivel de código fuente. Detecta fallos de adaptabilidad, barreras de accesibilidad, inconsistencias visuales y errores de maquetación.', 'slug': 'revisor-de-diseno-web'}
def main() -> int:
