---
name: revisor-de-diseno-web
description: Permite la inspección visual de sitios web para identificar y corregir problemas de diseño a nivel de código fuente. Detecta fallos de adaptabilidad, barreras de accesibilidad, inconsistencias visuales y errores de maquetación.
---

# Revisor de Diseño Web

## Propósito
Permite la inspección visual de sitios web para identificar y corregir problemas de diseño a nivel de código fuente. Detecta fallos de adaptabilidad, barreras de accesibilidad, inconsistencias visuales y errores de maquetación.
...
- **Runner:** `toolkit/phase-5-negocios/revisor-de-diseno-web/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/revisor-de-diseno-web/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/revisor-de-diseno-web/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/revisor-de-diseno-web/tests/test_smoke.py`
