...
SKILL = {'name': 'Creador de Obsidian Canvas', 'description': 'Convierte texto, artículos o esquemas en archivos estructurados de Obsidian Canvas. Admite tanto mapas mentales como diseños espaciales de forma libre para la organización visual del conocimiento.', 'slug': 'creador-de-obsidian-canvas'}
def main() -> int:
