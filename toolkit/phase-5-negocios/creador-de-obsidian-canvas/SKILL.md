---
name: creador-de-obsidian-canvas
description: Convierte texto, artículos o esquemas en archivos estructurados de Obsidian Canvas. Admite tanto mapas mentales como diseños espaciales de forma libre para la organización visual del conocimiento.
---

# Creador de Obsidian Canvas

## Propósito
Convierte texto, artículos o esquemas en archivos estructurados de Obsidian Canvas. Admite tanto mapas mentales como diseños espaciales de forma libre para la organización visual del conocimiento.
...
- **Runner:** `toolkit/phase-5-negocios/creador-de-obsidian-canvas/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/creador-de-obsidian-canvas/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/creador-de-obsidian-canvas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/creador-de-obsidian-canvas/tests/test_smoke.py`
