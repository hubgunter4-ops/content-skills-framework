---
name: visualizador-de-mermaid
description: Transforma contenido de texto complejo en diagramas de Mermaid profesionales. Proporciona prevención de errores de sintaxis integrada, ayudando a los usuarios a visualizar conceptos rápidamente y crear diagramas pulidos para presentaciones y documentación.
---

# Visualizador de Mermaid

## Propósito
Transforma contenido de texto complejo en diagramas de Mermaid profesionales. Proporciona prevención de errores de sintaxis integrada, ayudando a los usuarios a visualizar conceptos rápidamente y crear diagramas pulidos para presentaciones y documentación.
...
- **Runner:** `toolkit/phase-5-negocios/visualizador-de-mermaid/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/visualizador-de-mermaid/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/visualizador-de-mermaid/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/visualizador-de-mermaid/tests/test_smoke.py`
