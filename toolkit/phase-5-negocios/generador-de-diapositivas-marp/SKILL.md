---
name: generador-de-diapositivas-marp
description: Proporciona un generador de presentaciones basado en Marp con 7 temas integrados y guías de diseño detalladas. Transforma requisitos vagos o contenido sin procesar en código de diapositivas Markdown bien estructurado y con un formato atractivo.
---

# Generador de diapositivas Marp

## Propósito
Proporciona un generador de presentaciones basado en Marp con 7 temas integrados y guías de diseño detalladas. Transforma requisitos vagos o contenido sin procesar en código de diapositivas Markdown bien estructurado y con un formato atractivo.
...
- **Runner:** `toolkit/phase-5-negocios/generador-de-diapositivas-marp/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/generador-de-diapositivas-marp/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/generador-de-diapositivas-marp/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/generador-de-diapositivas-marp/tests/test_smoke.py`
