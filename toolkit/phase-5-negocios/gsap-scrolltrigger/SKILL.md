...
description: Proporciona capacidades de ScrollTrigger para crear animaciones vinculadas al desplazamiento, fijar elementos y manejar efectos de scrub. Simplifica las interacciones de desplazamiento complejas en un flujo de trabajo fiable.
---

# GSAP ScrollTrigger

## Propósito
Proporciona capacidades de ScrollTrigger para crear animaciones vinculadas al desplazamiento, fijar elementos y manejar efectos de scrub. Simplifica las interacciones de desplazamiento complejas en un flujo de trabajo fiable.
...
- **Runner:** `toolkit/phase-5-negocios/gsap-scrolltrigger/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/gsap-scrolltrigger/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/gsap-scrolltrigger/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/gsap-scrolltrigger/tests/test_smoke.py`
