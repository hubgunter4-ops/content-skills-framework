---
name: diagramador-de-excalidraw
description: Convierte contenido de texto en atractivos diagramas de Excalidraw. Ofrece modos de salida estándar y animados, ayudando a visualizar rápidamente ideas y procesos complejos sin necesidad de dibujo manual.
---

# Diagramador de Excalidraw

## Propósito
Convierte contenido de texto en atractivos diagramas de Excalidraw. Ofrece modos de salida estándar y animados, ayudando a visualizar rápidamente ideas y procesos complejos sin necesidad de dibujo manual.
...
- **Runner:** `toolkit/phase-5-negocios/diagramador-de-excalidraw/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/diagramador-de-excalidraw/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/diagramador-de-excalidraw/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/diagramador-de-excalidraw/tests/test_smoke.py`
