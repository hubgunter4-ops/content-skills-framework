...
SKILL = {'name': 'Diagramador de Excalidraw', 'description': 'Convierte contenido de texto en atractivos diagramas de Excalidraw. Ofrece modos de salida estándar y animados, ayudando a visualizar rápidamente ideas y procesos complejos sin necesidad de dibujo manual.', 'slug': 'diagramador-de-excalidraw'}
def main() -> int:
