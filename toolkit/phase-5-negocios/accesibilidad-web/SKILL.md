...
description: Audita y mejora la accesibilidad web siguiendo las pautas WCAG 2.2. Verifica el contraste de color, la navegación por teclado, los objetivos táctiles y el comportamiento del lector de pantalla.
---

# Accesibilidad web

## Propósito
Audita y mejora la accesibilidad web siguiendo las pautas WCAG 2.2. Verifica el contraste de color, la navegación por teclado, los objetivos táctiles y el comportamiento del lector de pantalla.
...
- **Runner:** `toolkit/phase-5-negocios/accesibilidad-web/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/accesibilidad-web/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/accesibilidad-web/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/accesibilidad-web/tests/test_smoke.py`
