...
description: Crea paneles HTML interactivos e independientes utilizando Chart.js, filtros desplegables y estilo profesional. Genera archivos HTML compartibles y con capacidad offline. Ideal para informes, presentaciones o entregables integrados.
---

# Constructor de Paneles Interactivos

## Propósito
Crea paneles HTML interactivos e independientes utilizando Chart.js, filtros desplegables y estilo profesional. Genera archivos HTML compartibles y con capacidad offline. Ideal para informes, presentaciones o entregables integrados.
...
- **Runner:** `toolkit/phase-5-negocios/constructor-de-paneles-interactivos/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/constructor-de-paneles-interactivos/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/constructor-de-paneles-interactivos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/constructor-de-paneles-interactivos/tests/test_smoke.py`
