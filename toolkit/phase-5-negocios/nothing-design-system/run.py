...
SKILL = {'name': 'Nothing Design System', 'description': 'Proporciona un lenguaje visual inspirado en Nothing para crear interfaces de estilo industrial y minimalista. Ayuda a los diseñadores y equipos de producto a aplicar una estética coherente más rápido en diferentes tipos de interfaz.', 'slug': 'nothing-design-system'}
def main() -> int:
