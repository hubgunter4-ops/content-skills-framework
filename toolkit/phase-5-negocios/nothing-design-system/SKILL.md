...
description: Proporciona un lenguaje visual inspirado en Nothing para crear interfaces de estilo industrial y minimalista. Ayuda a los diseñadores y equipos de producto a aplicar una estética coherente más rápido en diferentes tipos de interfaz.
---

# Nothing Design System

## Propósito
Proporciona un lenguaje visual inspirado en Nothing para crear interfaces de estilo industrial y minimalista. Ayuda a los diseñadores y equipos de producto a aplicar una estética coherente más rápido en diferentes tipos de interfaz.
...
- **Runner:** `toolkit/phase-5-negocios/nothing-design-system/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/nothing-design-system/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/nothing-design-system/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/nothing-design-system/tests/test_smoke.py`
