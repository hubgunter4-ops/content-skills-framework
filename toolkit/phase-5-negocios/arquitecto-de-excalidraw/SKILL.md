...
description: Delega las operaciones de archivos de Excalidraw a subagentes, evitando que el JSON detallado agote el contexto del agente principal. Permite la lectura, modificación y creación eficiente de diagramas de arquitectura y diagramas de flujo.
---

# Arquitecto de Excalidraw

## Propósito
Delega las operaciones de archivos de Excalidraw a subagentes, evitando que el JSON detallado agote el contexto del agente principal. Permite la lectura, modificación y creación eficiente de diagramas de arquitectura y diagramas de flujo.
...
- **Runner:** `toolkit/phase-5-negocios/arquitecto-de-excalidraw/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/arquitecto-de-excalidraw/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/arquitecto-de-excalidraw/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/arquitecto-de-excalidraw/tests/test_smoke.py`
