...
SKILL = {'name': 'PlantUML ASCII', 'description': 'Convierte diagramas de PlantUML en arte ASCII compatible con terminales y representaciones de texto mejoradas con Unicode. Genera diagramas de secuencia, diagramas de clases y diagramas de flujo.', 'slug': 'plantuml-ascii'}
def main() -> int:
