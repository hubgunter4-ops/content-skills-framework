...
SKILL = {'name': 'Ingeniero de Diseño Web', 'description': 'Construye páginas web pulidas, paneles de control, prototipos y visualizaciones de datos utilizando HTML, CSS, JavaScript y React. Combina flujos de trabajo detallados, sistemas de diseño y listas de verificación previas a la entrega.', 'slug': 'ingeniero-de-diseno-web'}
def main() -> int:
