---
name: maquetas-de-circuitos-clasicos
description: Genera maquetas detalladas de placas de pruebas y esquemas utilizando HTML5 Canvas. Ayuda a aficionados e ingenieros a producir rápidamente diagramas claros y compartibles para montajes 6502, temporizadores 555, lógica de la serie 7400, EEPROM y otros componentes retro.
---

# Maquetas de Circuitos Clásicos

## Propósito
Genera maquetas detalladas de placas de pruebas y esquemas utilizando HTML5 Canvas. Ayuda a aficionados e ingenieros a producir rápidamente diagramas claros y compartibles para montajes 6502, temporizadores 555, lógica de la serie 7400, EEPROM y otros componentes retro.
...
- **Runner:** `toolkit/phase-5-negocios/maquetas-de-circuitos-clasicos/run.py`
- **Motor:** `toolkit/phase_5_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-5-negocios/maquetas-de-circuitos-clasicos/input.example.json`
- **Esquema de salida:** `toolkit/phase-5-negocios/maquetas-de-circuitos-clasicos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-5-negocios/maquetas-de-circuitos-clasicos/tests/test_smoke.py`
