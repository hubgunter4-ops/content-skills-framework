---
name: fabrica-de-videos-ugc
description: Sintetiza imágenes de personas y productos en anuncios de video verticales de estilo UGC 9:16 con locuciones sincronizadas.
---

# Fábrica de Vídeos UGC

## Propósito
Sintetiza imágenes de personas y productos en anuncios de video verticales de estilo UGC 9:16 con locuciones sincronizadas.
...
- **Runner:** `toolkit/phase-6-medios/fabrica-de-videos-ugc/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/fabrica-de-videos-ugc/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/fabrica-de-videos-ugc/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/fabrica-de-videos-ugc/tests/test_smoke.py`
