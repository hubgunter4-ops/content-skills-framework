...
SKILL = {'name': 'Fábrica de Vídeos UGC', 'description': 'Sintetiza imágenes de personas y productos en anuncios de video verticales de estilo UGC 9:16 con locuciones sincronizadas.', 'slug': 'fabrica-de-videos-ugc'}
def main() -> int:
