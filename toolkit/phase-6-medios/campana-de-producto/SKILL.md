---
name: campana-de-producto
description: Genera un paquete completo de campaña de producto multicanal, que incluye visuales principales, imágenes para redes sociales y vídeos publicitarios cortos para lanzamientos de productos.
---

# Campaña de producto

## Propósito
Genera un paquete completo de campaña de producto multicanal, que incluye visuales principales, imágenes para redes sociales y vídeos publicitarios cortos para lanzamientos de productos.
...
- **Runner:** `toolkit/phase-6-medios/campana-de-producto/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/campana-de-producto/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/campana-de-producto/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/campana-de-producto/tests/test_smoke.py`
