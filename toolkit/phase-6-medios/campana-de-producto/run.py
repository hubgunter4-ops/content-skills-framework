...
SKILL = {'name': 'Campaña de producto', 'description': 'Genera un paquete completo de campaña de producto multicanal, que incluye visuales principales, imágenes para redes sociales y vídeos publicitarios cortos para lanzamientos de productos.', 'slug': 'campana-de-producto'}
def main() -> int:
