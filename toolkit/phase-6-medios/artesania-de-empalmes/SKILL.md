---
name: artesania-de-empalmes
description: Define los requisitos previos de corrección de renderizado para los empalmes entre escenas en los videos de lanzamiento de HyperFrames.
---

# Artesanía de Empalmes

## Propósito
Define los requisitos previos de corrección de renderizado para los empalmes entre escenas en los videos de lanzamiento de HyperFrames.
...
- **Runner:** `toolkit/phase-6-medios/artesania-de-empalmes/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/artesania-de-empalmes/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/artesania-de-empalmes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/artesania-de-empalmes/tests/test_smoke.py`
