...
SKILL = {'name': 'Shorts de vídeo con IA', 'description': 'Extrae automáticamente momentos divertidos o destacados de los vídeos, los reformatea en clips verticales de 9:16 e integra subtítulos palabra por palabra.', 'slug': 'shorts-de-video-con-ia'}
def main() -> int:
