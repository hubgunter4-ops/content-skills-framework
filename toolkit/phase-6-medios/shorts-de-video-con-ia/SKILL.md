---
name: shorts-de-video-con-ia
description: Extrae automáticamente momentos divertidos o destacados de los vídeos, los reformatea en clips verticales de 9:16 e integra subtítulos palabra por palabra.
---

# Shorts de vídeo con IA

## Propósito
Extrae automáticamente momentos divertidos o destacados de los vídeos, los reformatea en clips verticales de 9:16 e integra subtítulos palabra por palabra.
...
- **Runner:** `toolkit/phase-6-medios/shorts-de-video-con-ia/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/shorts-de-video-con-ia/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/shorts-de-video-con-ia/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/shorts-de-video-con-ia/tests/test_smoke.py`
