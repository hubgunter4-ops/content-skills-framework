...
SKILL = {'name': 'Cursor sobredimensionado', 'description': 'Proporciona una técnica de puntero de macOS sobredimensionado de estilo propio para vídeos de lanzamiento.', 'slug': 'cursor-sobredimensionado'}
def main() -> int:
