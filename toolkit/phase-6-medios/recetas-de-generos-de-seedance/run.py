...
SKILL = {'name': 'Recetas de géneros de Seedance', 'description': 'Ofrece recetas de producción reutilizables para Seedance 2.0: anuncios de productos, vídeos de estilo de vida, escenas dramáticas, vídeos musicales y tomas de paisajes.', 'slug': 'recetas-de-generos-de-seedance'}
def main() -> int:
