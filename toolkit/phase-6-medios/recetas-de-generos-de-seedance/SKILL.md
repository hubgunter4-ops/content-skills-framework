---
name: recetas-de-generos-de-seedance
description: Ofrece recetas de producción reutilizables para Seedance 2.0: anuncios de productos, vídeos de estilo de vida, escenas dramáticas, vídeos musicales y tomas de paisajes.
---

# Recetas de géneros de Seedance

## Propósito
Ofrece recetas de producción reutilizables para Seedance 2.0: anuncios de productos, vídeos de estilo de vida, escenas dramáticas, vídeos musicales y tomas de paisajes.
...
- **Runner:** `toolkit/phase-6-medios/recetas-de-generos-de-seedance/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/recetas-de-generos-de-seedance/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/recetas-de-generos-de-seedance/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/recetas-de-generos-de-seedance/tests/test_smoke.py`
