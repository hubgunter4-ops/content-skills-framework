...
SKILL = {'name': 'Anuncio Cinematográfico de Producto', 'description': 'Transforma una foto de producto estándar en un anuncio de video cinematográfico de 5 a 10 segundos basado en el resumen de tu marca.', 'slug': 'anuncio-cinematografico-de-producto'}
def main() -> int:
