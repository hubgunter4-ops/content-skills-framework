---
name: anuncio-cinematografico-de-producto
description: Transforma una foto de producto estándar en un anuncio de video cinematográfico de 5 a 10 segundos basado en el resumen de tu marca.
---

# Anuncio Cinematográfico de Producto

## Propósito
Transforma una foto de producto estándar en un anuncio de video cinematográfico de 5 a 10 segundos basado en el resumen de tu marca.
...
- **Runner:** `toolkit/phase-6-medios/anuncio-cinematografico-de-producto/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/anuncio-cinematografico-de-producto/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/anuncio-cinematografico-de-producto/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/anuncio-cinematografico-de-producto/tests/test_smoke.py`
