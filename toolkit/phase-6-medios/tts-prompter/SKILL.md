...
- **Runner:** `toolkit/phase-6-medios/tts-prompter/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/tts-prompter/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/tts-prompter/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/tts-prompter/tests/test_smoke.py`
