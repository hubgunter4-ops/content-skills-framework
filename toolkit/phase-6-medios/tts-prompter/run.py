...
SKILL = {'name': 'TTS Prompter', 'description': 'Domina la creación de prompts de texto a voz con marcos estructurados, separación de estilos y etiquetas de marcado expresivas.', 'slug': 'tts-prompter'}
def main() -> int:
