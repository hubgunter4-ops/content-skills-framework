...
SKILL = {'name': 'Vídeo con efecto de congelación', 'description': 'Convierte una única foto de retrato en una secuencia cinematográfica de "efecto de congelación" donde el tiempo se detiene a mitad de la escena.', 'slug': 'video-con-efecto-de-congelacion'}
def main() -> int:
