---
name: video-con-efecto-de-congelacion
description: Convierte una única foto de retrato en una secuencia cinematográfica de "efecto de congelación" donde el tiempo se detiene a mitad de la escena.
---

# Vídeo con efecto de congelación

## Propósito
Convierte una única foto de retrato en una secuencia cinematográfica de "efecto de congelación" donde el tiempo se detiene a mitad de la escena.
...
- **Runner:** `toolkit/phase-6-medios/video-con-efecto-de-congelacion/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-con-efecto-de-congelacion/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-con-efecto-de-congelacion/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-con-efecto-de-congelacion/tests/test_smoke.py`
