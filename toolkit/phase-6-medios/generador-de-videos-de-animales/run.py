...
SKILL = {'name': 'Generador de Vídeos de Animales', 'description': 'Crea vlogs de animales antropomórficos ultrarrealistas al permitir a los usuarios personalizar el animal, la ubicación, el atuendo y el diálogo.', 'slug': 'generador-de-videos-de-animales'}
def main() -> int:
