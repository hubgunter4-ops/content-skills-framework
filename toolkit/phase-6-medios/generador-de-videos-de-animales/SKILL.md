---
name: generador-de-videos-de-animales
description: Crea vlogs de animales antropomórficos ultrarrealistas al permitir a los usuarios personalizar el animal, la ubicación, el atuendo y el diálogo.
---

# Generador de Vídeos de Animales

## Propósito
Crea vlogs de animales antropomórficos ultrarrealistas al permitir a los usuarios personalizar el animal, la ubicación, el atuendo y el diálogo.
...
- **Runner:** `toolkit/phase-6-medios/generador-de-videos-de-animales/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/generador-de-videos-de-animales/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/generador-de-videos-de-animales/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/generador-de-videos-de-animales/tests/test_smoke.py`
