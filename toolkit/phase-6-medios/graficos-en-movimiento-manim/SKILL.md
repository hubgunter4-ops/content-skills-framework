---
name: graficos-en-movimiento-manim
description: Crea tipografía cinética, revelaciones de logotipos y secuencias de títulos con el motor Manim. Ideal para intros de canales y vídeos de eslóganes con un estilo geométrico limpio.
---

# Gráficos en movimiento Manim

## Propósito
Crea tipografía cinética, revelaciones de logotipos y secuencias de títulos con el motor Manim. Ideal para intros de canales y vídeos de eslóganes con un estilo geométrico limpio.
...
- **Runner:** `toolkit/phase-6-medios/graficos-en-movimiento-manim/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/graficos-en-movimiento-manim/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/graficos-en-movimiento-manim/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/graficos-en-movimiento-manim/tests/test_smoke.py`
