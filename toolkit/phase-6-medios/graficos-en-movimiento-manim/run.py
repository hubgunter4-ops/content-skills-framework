...
SKILL = {'name': 'Gráficos en movimiento Manim', 'description': 'Crea tipografía cinética, revelaciones de logotipos y secuencias de títulos con el motor Manim. Ideal para intros de canales y vídeos de eslóganes con un estilo geométrico limpio.', 'slug': 'graficos-en-movimiento-manim'}
def main() -> int:
