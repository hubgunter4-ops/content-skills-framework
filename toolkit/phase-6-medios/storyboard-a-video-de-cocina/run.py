...
SKILL = {'name': 'Storyboard a Video de Cocina', 'description': 'Transforma una sola foto en un video tutorial de cocina cinematográfico de 15 segundos.', 'slug': 'storyboard-a-video-de-cocina'}
def main() -> int:
