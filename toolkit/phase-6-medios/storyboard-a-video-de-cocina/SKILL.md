---
name: storyboard-a-video-de-cocina
description: Transforma una sola foto en un video tutorial de cocina cinematográfico de 15 segundos.
---

# Storyboard a Video de Cocina

## Propósito
Transforma una sola foto en un video tutorial de cocina cinematográfico de 15 segundos.
...
- **Runner:** `toolkit/phase-6-medios/storyboard-a-video-de-cocina/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/storyboard-a-video-de-cocina/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/storyboard-a-video-de-cocina/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/storyboard-a-video-de-cocina/tests/test_smoke.py`
