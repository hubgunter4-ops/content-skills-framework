...
SKILL = {'name': 'Video estilo dron', 'description': 'Crea impresionantes metrajes aéreos con perspectiva de dron, incluyendo vistas panorámicas a ojo de pájaro, tomas orbitales y secuencias de sobrevuelo.', 'slug': 'video-estilo-dron'}
def main() -> int:
