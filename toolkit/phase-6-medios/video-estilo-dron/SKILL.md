---
name: video-estilo-dron
description: Crea impresionantes metrajes aéreos con perspectiva de dron, incluyendo vistas panorámicas a ojo de pájaro, tomas orbitales y secuencias de sobrevuelo.
---

# Video estilo dron

## Propósito
Crea impresionantes metrajes aéreos con perspectiva de dron, incluyendo vistas panorámicas a ojo de pájaro, tomas orbitales y secuencias de sobrevuelo.
...
- **Runner:** `toolkit/phase-6-medios/video-estilo-dron/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-estilo-dron/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-estilo-dron/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-estilo-dron/tests/test_smoke.py`
