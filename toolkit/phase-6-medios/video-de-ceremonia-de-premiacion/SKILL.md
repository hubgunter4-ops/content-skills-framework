---
name: video-de-ceremonia-de-premiacion
description: Transforma dos fotos en un video cinematográfico de 15 segundos de una ceremonia de premiación, completo con el anuncio del presentador, seguimiento de focos, aceptación en el escenario y títulos personalizados en pantalla LED.
---

# Video de Ceremonia de Premiación

## Propósito
Transforma dos fotos en un video cinematográfico de 15 segundos de una ceremonia de premiación, completo con el anuncio del presentador, seguimiento de focos, aceptación en el escenario y títulos personalizados en pantalla LED.
...
- **Runner:** `toolkit/phase-6-medios/video-de-ceremonia-de-premiacion/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-de-ceremonia-de-premiacion/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-de-ceremonia-de-premiacion/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-de-ceremonia-de-premiacion/tests/test_smoke.py`
