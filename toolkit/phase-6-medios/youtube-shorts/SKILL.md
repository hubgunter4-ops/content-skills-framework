---
name: youtube-shorts
description: Identifica y extrae momentos destacados virales de contenido de larga duración, formateándolos específicamente para YouTube Shorts, TikTok e Instagram Reels.
---

# YouTube Shorts

## Propósito
Identifica y extrae momentos destacados virales de contenido de larga duración, formateándolos específicamente para YouTube Shorts, TikTok e Instagram Reels.
...
- **Runner:** `toolkit/phase-6-medios/youtube-shorts/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/youtube-shorts/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/youtube-shorts/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/youtube-shorts/tests/test_smoke.py`
