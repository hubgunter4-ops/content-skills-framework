...
SKILL = {'name': 'YouTube Shorts', 'description': 'Identifica y extrae momentos destacados virales de contenido de larga duración, formateándolos específicamente para YouTube Shorts, TikTok e Instagram Reels.', 'slug': 'youtube-shorts'}
def main() -> int:
