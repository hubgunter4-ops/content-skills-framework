---
name: superposicion-de-subtitulos
description: Proporciona una doctrina concisa para añadir subtítulos y leyendas a composiciones filmadas, diseñada para complementar un flujo de trabajo de subtítulos incrustados.
---

# Superposición de subtítulos

## Propósito
Proporciona una doctrina concisa para añadir subtítulos y leyendas a composiciones filmadas, diseñada para complementar un flujo de trabajo de subtítulos incrustados.
...
- **Runner:** `toolkit/phase-6-medios/superposicion-de-subtitulos/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/superposicion-de-subtitulos/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/superposicion-de-subtitulos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/superposicion-de-subtitulos/tests/test_smoke.py`
