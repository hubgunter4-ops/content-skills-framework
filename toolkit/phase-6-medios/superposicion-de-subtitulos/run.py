...
SKILL = {'name': 'Superposición de subtítulos', 'description': 'Proporciona una doctrina concisa para añadir subtítulos y leyendas a composiciones filmadas, diseñada para complementar un flujo de trabajo de subtítulos incrustados.', 'slug': 'superposicion-de-subtitulos'}
def main() -> int:
