...
SKILL = {'name': 'Video de bebé que habla', 'description': 'Crea videos de estilo viral de un bebé que habla con disfraces y guiones personalizados.', 'slug': 'video-de-bebe-que-habla'}
def main() -> int:
