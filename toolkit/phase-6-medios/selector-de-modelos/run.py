...
SKILL = {'name': 'Selector de Modelos', 'description': 'Actúa como un asesor inteligente, recomendando la mejor opción entre 16 modelos comerciales y de código abierto convencionales basándose en sus necesidades específicas.', 'slug': 'selector-de-modelos'}
def main() -> int:
