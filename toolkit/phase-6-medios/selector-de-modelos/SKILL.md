---
name: selector-de-modelos
description: Actúa como un asesor inteligente, recomendando la mejor opción entre 16 modelos comerciales y de código abierto convencionales basándose en sus necesidades específicas.
---

# Selector de Modelos

## Propósito
Actúa como un asesor inteligente, recomendando la mejor opción entre 16 modelos comerciales y de código abierto convencionales basándose en sus necesidades específicas.
...
- **Runner:** `toolkit/phase-6-medios/selector-de-modelos/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/selector-de-modelos/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/selector-de-modelos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/selector-de-modelos/tests/test_smoke.py`
