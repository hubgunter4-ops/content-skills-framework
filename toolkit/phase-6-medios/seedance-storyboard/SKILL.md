...
description: Convierte esquemas de tramas simples en prompts profesionales de múltiples tomas que incluyen movimiento de cámara, acción, espacio y dimensiones de audio.
---

# Seedance Storyboard

## Propósito
Convierte esquemas de tramas simples en prompts profesionales de múltiples tomas que incluyen movimiento de cámara, acción, espacio y dimensiones de audio.
...
- **Runner:** `toolkit/phase-6-medios/seedance-storyboard/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/seedance-storyboard/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/seedance-storyboard/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/seedance-storyboard/tests/test_smoke.py`
