...
SKILL = {'name': 'Seedance Storyboard', 'description': 'Convierte esquemas de tramas simples en prompts profesionales de múltiples tomas que incluyen movimiento de cámara, acción, espacio y dimensiones de audio.', 'slug': 'seedance-storyboard'}
def main() -> int:
