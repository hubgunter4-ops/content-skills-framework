...
SKILL = {'name': 'Marco cinematográfico con filtraciones de luz', 'description': 'Crea títulos de apertura cinematográficos y tarjetas de capítulo con filtraciones de luz de película, textura de grano, formato letterbox 16:9 y tipografía con serifa grande.', 'slug': 'marco-cinematografico-con-filtraciones-de-luz'}
def main() -> int:
