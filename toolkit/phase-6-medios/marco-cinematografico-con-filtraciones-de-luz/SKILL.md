---
name: marco-cinematografico-con-filtraciones-de-luz
description: Crea títulos de apertura cinematográficos y tarjetas de capítulo con filtraciones de luz de película, textura de grano, formato letterbox 16:9 y tipografía con serifa grande.
---

# Marco cinematográfico con filtraciones de luz

## Propósito
Crea títulos de apertura cinematográficos y tarjetas de capítulo con filtraciones de luz de película, textura de grano, formato letterbox 16:9 y tipografía con serifa grande.
...
- **Runner:** `toolkit/phase-6-medios/marco-cinematografico-con-filtraciones-de-luz/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/marco-cinematografico-con-filtraciones-de-luz/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/marco-cinematografico-con-filtraciones-de-luz/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/marco-cinematografico-con-filtraciones-de-luz/tests/test_smoke.py`
