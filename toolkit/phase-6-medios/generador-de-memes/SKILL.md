...
description: Genera imágenes con subtítulos a partir de más de 170 plantillas clásicas a través de la API gratuita Memegen.link.
---

# Generador de memes

## Propósito
Genera imágenes con subtítulos a partir de más de 170 plantillas clásicas a través de la API gratuita Memegen.link.
...
- **Runner:** `toolkit/phase-6-medios/generador-de-memes/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/generador-de-memes/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/generador-de-memes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/generador-de-memes/tests/test_smoke.py`
