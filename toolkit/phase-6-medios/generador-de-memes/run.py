...
SKILL = {'name': 'Generador de memes', 'description': 'Genera imágenes con subtítulos a partir de más de 170 plantillas clásicas a través de la API gratuita Memegen.link.', 'slug': 'generador-de-memes'}
def main() -> int:
