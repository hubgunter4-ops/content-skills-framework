...
description: Traduce ideas creativas simples en prompts profesionales de generación de vídeo con movimientos de cámara, iluminación y composición cinematográficos.
---

# Director de Cine

## Propósito
Traduce ideas creativas simples en prompts profesionales de generación de vídeo con movimientos de cámara, iluminación y composición cinematográficos.
...
- **Runner:** `toolkit/phase-6-medios/director-de-cine/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/director-de-cine/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/director-de-cine/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/director-de-cine/tests/test_smoke.py`
