...
SKILL = {'name': 'Director de Cine', 'description': 'Traduce ideas creativas simples en prompts profesionales de generación de vídeo con movimientos de cámara, iluminación y composición cinematográficos.', 'slug': 'director-de-cine'}
def main() -> int:
