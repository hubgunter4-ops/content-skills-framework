...
description: Repara fotos antiguas, borrosas y dañadas convirtiéndolas en imágenes de alta definición 8K, preservando estrictamente la identidad de cada persona.
---

# Restauración de fotos

## Propósito
Repara fotos antiguas, borrosas y dañadas convirtiéndolas en imágenes de alta definición 8K, preservando estrictamente la identidad de cada persona.
...
- **Runner:** `toolkit/phase-6-medios/restauracion-de-fotos/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/restauracion-de-fotos/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/restauracion-de-fotos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/restauracion-de-fotos/tests/test_smoke.py`
