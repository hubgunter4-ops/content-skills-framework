...
SKILL = {'name': 'Animación de baile de dibujos animados', 'description': 'Convierte una foto humana en un personaje de dibujos animados en 3D al estilo Pixar y lo anima utilizando un video de baile o movimiento de referencia.', 'slug': 'animacion-de-baile-de-dibujos-animados'}
def main() -> int:
