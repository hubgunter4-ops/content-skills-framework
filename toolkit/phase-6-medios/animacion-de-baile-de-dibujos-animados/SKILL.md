---
name: animacion-de-baile-de-dibujos-animados
description: Convierte una foto humana en un personaje de dibujos animados en 3D al estilo Pixar y lo anima utilizando un video de baile o movimiento de referencia.
---

# Animación de baile de dibujos animados

## Propósito
Convierte una foto humana en un personaje de dibujos animados en 3D al estilo Pixar y lo anima utilizando un video de baile o movimiento de referencia.
...
- **Runner:** `toolkit/phase-6-medios/animacion-de-baile-de-dibujos-animados/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/animacion-de-baile-de-dibujos-animados/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/animacion-de-baile-de-dibujos-animados/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/animacion-de-baile-de-dibujos-animados/tests/test_smoke.py`
