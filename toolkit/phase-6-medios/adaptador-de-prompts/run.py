...
SKILL = {'name': 'Adaptador de Prompts', 'description': 'Traduce prompts de video de IA del estilo de un modelo de origen a las mejores prácticas de un modelo de destino.', 'slug': 'adaptador-de-prompts'}
def main() -> int:
