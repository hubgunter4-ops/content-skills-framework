---
name: adaptador-de-prompts
description: Traduce prompts de video de IA del estilo de un modelo de origen a las mejores prácticas de un modelo de destino.
---

# Adaptador de Prompts

## Propósito
Traduce prompts de video de IA del estilo de un modelo de origen a las mejores prácticas de un modelo de destino.
...
- **Runner:** `toolkit/phase-6-medios/adaptador-de-prompts/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/adaptador-de-prompts/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/adaptador-de-prompts/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/adaptador-de-prompts/tests/test_smoke.py`
