---
name: animador-manim
description: Crea videos de animación explicativos basados en código y gráficos vectoriales precisos. Ideal para visualizaciones matemáticas, tutoriales de algoritmos, explicaciones de conceptos científicos y animaciones al estilo de 3Blue1Brown.
---

# Animador Manim

## Propósito
Crea videos de animación explicativos basados en código y gráficos vectoriales precisos. Ideal para visualizaciones matemáticas, tutoriales de algoritmos, explicaciones de conceptos científicos y animaciones al estilo de 3Blue1Brown.
...
- **Runner:** `toolkit/phase-6-medios/animador-manim/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/animador-manim/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/animador-manim/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/animador-manim/tests/test_smoke.py`
