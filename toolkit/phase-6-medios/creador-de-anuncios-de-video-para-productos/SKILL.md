---
name: creador-de-anuncios-de-video-para-productos
description: Convierte una simple foto de producto en un anuncio de video cinematográfico de alta gama. Combina el procesamiento de imágenes y la generación de video en un flujo de trabajo de dos pasos.
---

# Creador de anuncios de video para productos

## Propósito
Convierte una simple foto de producto en un anuncio de video cinematográfico de alta gama. Combina el procesamiento de imágenes y la generación de video en un flujo de trabajo de dos pasos.
...
- **Runner:** `toolkit/phase-6-medios/creador-de-anuncios-de-video-para-productos/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/creador-de-anuncios-de-video-para-productos/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/creador-de-anuncios-de-video-para-productos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/creador-de-anuncios-de-video-para-productos/tests/test_smoke.py`
