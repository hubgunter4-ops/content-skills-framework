...
SKILL = {'name': 'Kit de herramientas ImageMagick', 'description': 'Procesa y manipula imágenes utilizando ImageMagick, lo que permite cambiar el tamaño, convertir formatos, procesar por lotes y extraer metadatos de imagen.', 'slug': 'kit-de-herramientas-imagemagick'}
def main() -> int:
