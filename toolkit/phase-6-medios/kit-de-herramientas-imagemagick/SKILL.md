---
name: kit-de-herramientas-imagemagick
description: Procesa y manipula imágenes utilizando ImageMagick, lo que permite cambiar el tamaño, convertir formatos, procesar por lotes y extraer metadatos de imagen.
---

# Kit de herramientas ImageMagick

## Propósito
Procesa y manipula imágenes utilizando ImageMagick, lo que permite cambiar el tamaño, convertir formatos, procesar por lotes y extraer metadatos de imagen.
...
- **Runner:** `toolkit/phase-6-medios/kit-de-herramientas-imagemagick/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/kit-de-herramientas-imagemagick/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/kit-de-herramientas-imagemagick/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/kit-de-herramientas-imagemagick/tests/test_smoke.py`
