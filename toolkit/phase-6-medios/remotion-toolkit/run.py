...
SKILL = {'name': 'Remotion Toolkit', 'description': 'Aporta patrones de Remotion probados en batalla —transiciones personalizadas, componentes compartidos y convenciones de proyectos— para crear videos con código React.', 'slug': 'remotion-toolkit'}
def main() -> int:
