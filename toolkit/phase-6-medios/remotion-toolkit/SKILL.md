...
description: Aporta patrones de Remotion probados en batalla —transiciones personalizadas, componentes compartidos y convenciones de proyectos— para crear videos con código React.
---

# Remotion Toolkit

## Propósito
Aporta patrones de Remotion probados en batalla —transiciones personalizadas, componentes compartidos y convenciones de proyectos— para crear videos con código React.
...
- **Runner:** `toolkit/phase-6-medios/remotion-toolkit/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/remotion-toolkit/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/remotion-toolkit/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/remotion-toolkit/tests/test_smoke.py`
