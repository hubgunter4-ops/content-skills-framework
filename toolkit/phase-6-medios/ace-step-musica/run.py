...
SKILL = {'name': 'ACE-Step Música', 'description': 'Genera música con el modelo de código abierto ACE-Step — pistas de fondo, voces, covers, extracción de stems, repintado de audio y continuación.', 'slug': 'ace-step-musica'}
def main() -> int:
