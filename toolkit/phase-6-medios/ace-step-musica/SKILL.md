---
name: ace-step-musica
description: Genera música con el modelo de código abierto ACE-Step — pistas de fondo, voces, covers, extracción de stems, repintado de audio y continuación.
---

# ACE-Step Música

## Propósito
Genera música con el modelo de código abierto ACE-Step — pistas de fondo, voces, covers, extracción de stems, repintado de audio y continuación.
...
- **Runner:** `toolkit/phase-6-medios/ace-step-musica/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/ace-step-musica/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/ace-step-musica/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/ace-step-musica/tests/test_smoke.py`
