---
name: video-de-presentacion-de-producto
description: Genera videos dinámicos de presentación de productos con disposiciones explosivas de ingredientes y animaciones de movimiento realistas.
---

# Video de presentación de producto

## Propósito
Genera videos dinámicos de presentación de productos con disposiciones explosivas de ingredientes y animaciones de movimiento realistas.
...
- **Runner:** `toolkit/phase-6-medios/video-de-presentacion-de-producto/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-de-presentacion-de-producto/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-de-presentacion-de-producto/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-de-presentacion-de-producto/tests/test_smoke.py`
