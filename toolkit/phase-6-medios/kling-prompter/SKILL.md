---
name: kling-prompter
description: Genera prompts de video profesionales optimizados para Kling 3.0, admitiendo clips cortos, videos narrativos con audio nativo y generación de imagen a video.
---

# Kling Prompter

## Propósito
Genera prompts de video profesionales optimizados para Kling 3.0, admitiendo clips cortos, videos narrativos con audio nativo y generación de imagen a video.
...
- **Runner:** `toolkit/phase-6-medios/kling-prompter/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/kling-prompter/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/kling-prompter/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/kling-prompter/tests/test_smoke.py`
