...
SKILL = {'name': 'Kling Prompter', 'description': 'Genera prompts de video profesionales optimizados para Kling 3.0, admitiendo clips cortos, videos narrativos con audio nativo y generación de imagen a video.', 'slug': 'kling-prompter'}
def main() -> int:
