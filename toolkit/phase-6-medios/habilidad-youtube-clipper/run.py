...
SKILL = {'name': 'Habilidad YouTube Clipper', 'description': 'Utiliza IA para analizar el contenido, extraer momentos clave y generar resúmenes de momentos destacados o clips cortos.', 'slug': 'habilidad-youtube-clipper'}
def main() -> int:
