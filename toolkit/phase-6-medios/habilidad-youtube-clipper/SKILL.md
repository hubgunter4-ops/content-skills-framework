---
name: habilidad-youtube-clipper
description: Utiliza IA para analizar el contenido, extraer momentos clave y generar resúmenes de momentos destacados o clips cortos.
---

# Habilidad YouTube Clipper

## Propósito
Utiliza IA para analizar el contenido, extraer momentos clave y generar resúmenes de momentos destacados o clips cortos.
...
- **Runner:** `toolkit/phase-6-medios/habilidad-youtube-clipper/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/habilidad-youtube-clipper/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/habilidad-youtube-clipper/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/habilidad-youtube-clipper/tests/test_smoke.py`
