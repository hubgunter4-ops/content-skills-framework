---
name: video-de-historia-de-personajes
description: Crea videos de historias animadas de varias partes estableciendo un personaje consistente, generando escenas secuenciales y animándolas.
---

# Video de historia de personajes

## Propósito
Crea videos de historias animadas de varias partes estableciendo un personaje consistente, generando escenas secuenciales y animándolas.
...
- **Runner:** `toolkit/phase-6-medios/video-de-historia-de-personajes/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-de-historia-de-personajes/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-de-historia-de-personajes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-de-historia-de-personajes/tests/test_smoke.py`
