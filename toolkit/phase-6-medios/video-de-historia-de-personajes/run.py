...
SKILL = {'name': 'Video de historia de personajes', 'description': 'Crea videos de historias animadas de varias partes estableciendo un personaje consistente, generando escenas secuenciales y animándolas.', 'slug': 'video-de-historia-de-personajes'}
def main() -> int:
