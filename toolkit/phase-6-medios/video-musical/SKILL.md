---
name: video-musical
description: Genera un video musical corto a partir de un tema dado mediante la creación de múltiples escenas de fotogramas clave, animándolas y añadiendo música de fondo a juego.
---

# Video musical

## Propósito
Genera un video musical corto a partir de un tema dado mediante la creación de múltiples escenas de fotogramas clave, animándolas y añadiendo música de fondo a juego.
...
- **Runner:** `toolkit/phase-6-medios/video-musical/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-musical/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-musical/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-musical/tests/test_smoke.py`
