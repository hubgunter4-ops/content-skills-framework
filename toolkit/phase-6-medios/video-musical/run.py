...
SKILL = {'name': 'Video musical', 'description': 'Genera un video musical corto a partir de un tema dado mediante la creación de múltiples escenas de fotogramas clave, animándolas y añadiendo música de fondo a juego.', 'slug': 'video-musical'}
def main() -> int:
