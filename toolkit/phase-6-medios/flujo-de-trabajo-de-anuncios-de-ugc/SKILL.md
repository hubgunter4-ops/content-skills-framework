---
name: flujo-de-trabajo-de-anuncios-de-ugc
description: Crea anuncios de video de contenido generado por el usuario UGC combinando un selfie humano y una imagen de producto.
---

# Flujo de trabajo de anuncios de UGC

## Propósito
Crea anuncios de video de contenido generado por el usuario UGC combinando un selfie humano y una imagen de producto.
...
- **Runner:** `toolkit/phase-6-medios/flujo-de-trabajo-de-anuncios-de-ugc/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/flujo-de-trabajo-de-anuncios-de-ugc/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/flujo-de-trabajo-de-anuncios-de-ugc/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/flujo-de-trabajo-de-anuncios-de-ugc/tests/test_smoke.py`
