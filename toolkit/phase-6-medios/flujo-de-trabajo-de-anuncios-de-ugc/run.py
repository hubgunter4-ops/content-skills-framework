...
SKILL = {'name': 'Flujo de trabajo de anuncios de UGC', 'description': 'Crea anuncios de video de contenido generado por el usuario UGC combinando un selfie humano y una imagen de producto.', 'slug': 'flujo-de-trabajo-de-anuncios-de-ugc'}
def main() -> int:
