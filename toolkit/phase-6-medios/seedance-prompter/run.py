...
SKILL = {'name': 'Seedance Prompter', 'description': 'Traduce ideas simples de video en prompts estructurados en inglés de nivel ingeniería, optimizados para Doubao Seedance 2.0.', 'slug': 'seedance-prompter'}
def main() -> int:
