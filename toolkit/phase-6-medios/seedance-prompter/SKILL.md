...
description: Traduce ideas simples de video en prompts estructurados en inglés de nivel ingeniería, optimizados para Doubao Seedance 2.0.
---

# Seedance Prompter

## Propósito
Traduce ideas simples de video en prompts estructurados en inglés de nivel ingeniería, optimizados para Doubao Seedance 2.0.
...
- **Runner:** `toolkit/phase-6-medios/seedance-prompter/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/seedance-prompter/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/seedance-prompter/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/seedance-prompter/tests/test_smoke.py`
