---
name: exhibicion-de-productos-gigantes
description: Transforma fotos de productos estándar en visuales dramáticos de "productos gigantes" del tamaño de un edificio junto a figuras humanas.
---

# Exhibición de Productos Gigantes

## Propósito
Transforma fotos de productos estándar en visuales dramáticos de "productos gigantes" del tamaño de un edificio junto a figuras humanas.
...
- **Runner:** `toolkit/phase-6-medios/exhibicion-de-productos-gigantes/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/exhibicion-de-productos-gigantes/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/exhibicion-de-productos-gigantes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/exhibicion-de-productos-gigantes/tests/test_smoke.py`
