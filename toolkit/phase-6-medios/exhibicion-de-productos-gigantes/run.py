...
SKILL = {'name': 'Exhibición de Productos Gigantes', 'description': 'Transforma fotos de productos estándar en visuales dramáticos de "productos gigantes" del tamaño de un edificio junto a figuras humanas.', 'slug': 'exhibicion-de-productos-gigantes'}
def main() -> int:
