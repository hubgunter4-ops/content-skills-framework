---
name: escena-de-lucha-con-ia
description: Crea videos de escenas de lucha de alta energía construyendo primero un guion gráfico de 16 paneles y luego convirtiéndolo en una secuencia de imagen a video.
---

# Escena de lucha con IA

## Propósito
Crea videos de escenas de lucha de alta energía construyendo primero un guion gráfico de 16 paneles y luego convirtiéndolo en una secuencia de imagen a video.
...
- **Runner:** `toolkit/phase-6-medios/escena-de-lucha-con-ia/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/escena-de-lucha-con-ia/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/escena-de-lucha-con-ia/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/escena-de-lucha-con-ia/tests/test_smoke.py`
