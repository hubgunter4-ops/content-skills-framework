...
SKILL = {'name': 'Escena de lucha con IA', 'description': 'Crea videos de escenas de lucha de alta energía construyendo primero un guion gráfico de 16 paneles y luego convirtiéndolo en una secuencia de imagen a video.', 'slug': 'escena-de-lucha-con-ia'}
def main() -> int:
