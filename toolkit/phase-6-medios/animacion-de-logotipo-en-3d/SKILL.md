...
description: Convierte un logotipo estándar en 2D en una animación 3D con materiales dimensionales, iluminación cinematográfica y movimiento de cámara para intros de video, sitios web y publicaciones en redes sociales.
---

# Animación de logotipo en 3D

## Propósito
Convierte un logotipo estándar en 2D en una animación 3D con materiales dimensionales, iluminación cinematográfica y movimiento de cámara para intros de video, sitios web y publicaciones en redes sociales.
...
- **Runner:** `toolkit/phase-6-medios/animacion-de-logotipo-en-3d/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/animacion-de-logotipo-en-3d/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/animacion-de-logotipo-en-3d/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/animacion-de-logotipo-en-3d/tests/test_smoke.py`
