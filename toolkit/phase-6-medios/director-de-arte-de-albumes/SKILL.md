---
name: director-de-arte-de-albumes
description: Desarrolla conceptos visuales para el arte de álbumes basados en el género y el estado de ánimo de tu música, luego genera prompts de arte de IA para producirlos.
---

# Director de arte de álbumes

## Propósito
Desarrolla conceptos visuales para el arte de álbumes basados en el género y el estado de ánimo de tu música, luego genera prompts de arte de IA para producirlos.
...
- **Runner:** `toolkit/phase-6-medios/director-de-arte-de-albumes/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/director-de-arte-de-albumes/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/director-de-arte-de-albumes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/director-de-arte-de-albumes/tests/test_smoke.py`
