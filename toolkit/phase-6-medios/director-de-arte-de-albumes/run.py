...
SKILL = {'name': 'Director de arte de álbumes', 'description': 'Desarrolla conceptos visuales para el arte de álbumes basados en el género y el estado de ánimo de tu música, luego genera prompts de arte de IA para producirlos.', 'slug': 'director-de-arte-de-albumes'}
def main() -> int:
