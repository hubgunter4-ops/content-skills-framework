...
SKILL = {'name': 'Generador de videos con IA', 'description': 'Planifica y produce videos generados por IA, cortometrajes, anuncios comerciales y otros contenidos de video profesionales.', 'slug': 'generador-de-videos-con-ia'}
def main() -> int:
