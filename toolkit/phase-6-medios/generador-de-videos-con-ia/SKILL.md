...
description: Planifica y produce videos generados por IA, cortometrajes, anuncios comerciales y otros contenidos de video profesionales.
---

# Generador de videos con IA

## Propósito
Planifica y produce videos generados por IA, cortometrajes, anuncios comerciales y otros contenidos de video profesionales.
...
- **Runner:** `toolkit/phase-6-medios/generador-de-videos-con-ia/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/generador-de-videos-con-ia/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/generador-de-videos-con-ia/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/generador-de-videos-con-ia/tests/test_smoke.py`
