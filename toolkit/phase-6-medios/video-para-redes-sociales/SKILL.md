...
description: Crea videos cortos listos para plataformas mediante la lectura de su identidad de marca, público objetivo y documentos de mensajes. Automatiza el proceso de redacción de guiones gráficos, elaboración de prompts optimizados y generación de marcos de referencia.
---

# Video para redes sociales

## Propósito
Crea videos cortos listos para plataformas mediante la lectura de su identidad de marca, público objetivo y documentos de mensajes. Automatiza el proceso de redacción de guiones gráficos, elaboración de prompts optimizados y generación de marcos de referencia.
...
- **Runner:** `toolkit/phase-6-medios/video-para-redes-sociales/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-para-redes-sociales/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-para-redes-sociales/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-para-redes-sociales/tests/test_smoke.py`
