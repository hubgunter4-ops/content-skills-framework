...
SKILL = {'name': 'Video para redes sociales', 'description': 'Crea videos cortos listos para plataformas mediante la lectura de su identidad de marca, público objetivo y documentos de mensajes. Automatiza el proceso de redacción de guiones gráficos, elaboración de prompts optimizados y generación de marcos de referencia.', 'slug': 'video-para-redes-sociales'}
def main() -> int:
