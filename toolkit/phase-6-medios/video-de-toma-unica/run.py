...
SKILL = {'name': 'Vídeo de toma única', 'description': 'Genera vídeos cinematográficos de toma única como una escena continua, creando metraje fluido de larga duración sin cortes ni transiciones.', 'slug': 'video-de-toma-unica'}
def main() -> int:
