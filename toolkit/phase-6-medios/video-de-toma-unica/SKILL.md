---
name: video-de-toma-unica
description: Genera vídeos cinematográficos de toma única como una escena continua, creando metraje fluido de larga duración sin cortes ni transiciones.
---

# Vídeo de toma única

## Propósito
Genera vídeos cinematográficos de toma única como una escena continua, creando metraje fluido de larga duración sin cortes ni transiciones.
...
- **Runner:** `toolkit/phase-6-medios/video-de-toma-unica/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-de-toma-unica/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-de-toma-unica/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-de-toma-unica/tests/test_smoke.py`
