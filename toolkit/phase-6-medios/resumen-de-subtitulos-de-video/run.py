...
SKILL = {'name': 'Resumen de subtítulos de vídeo', 'description': 'Convierte vídeos de Douyin, Xiaohongshu, Bilibili, YouTube o archivos locales en subtítulos y resúmenes de IA utilizando la transcripción local faster-whisper.', 'slug': 'resumen-de-subtitulos-de-video'}
def main() -> int:
