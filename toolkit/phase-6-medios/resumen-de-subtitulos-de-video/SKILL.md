...
description: Convierte vídeos de Douyin, Xiaohongshu, Bilibili, YouTube o archivos locales en subtítulos y resúmenes de IA utilizando la transcripción local faster-whisper.
---

# Resumen de subtítulos de vídeo

## Propósito
Convierte vídeos de Douyin, Xiaohongshu, Bilibili, YouTube o archivos locales en subtítulos y resúmenes de IA utilizando la transcripción local faster-whisper.
...
- **Runner:** `toolkit/phase-6-medios/resumen-de-subtitulos-de-video/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/resumen-de-subtitulos-de-video/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/resumen-de-subtitulos-de-video/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/resumen-de-subtitulos-de-video/tests/test_smoke.py`
