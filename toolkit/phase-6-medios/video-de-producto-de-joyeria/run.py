...
SKILL = {'name': 'Video de producto de joyería', 'description': 'Genera videos publicitarios de joyería de lujo de alta gama con animaciones macro detalladas y movimientos de cámara cinematográficos.', 'slug': 'video-de-producto-de-joyeria'}
def main() -> int:
