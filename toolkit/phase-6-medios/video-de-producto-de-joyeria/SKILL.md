---
name: video-de-producto-de-joyeria
description: Genera videos publicitarios de joyería de lujo de alta gama con animaciones macro detalladas y movimientos de cámara cinematográficos.
---

# Video de producto de joyería

## Propósito
Genera videos publicitarios de joyería de lujo de alta gama con animaciones macro detalladas y movimientos de cámara cinematográficos.
...
- **Runner:** `toolkit/phase-6-medios/video-de-producto-de-joyeria/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/video-de-producto-de-joyeria/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/video-de-producto-de-joyeria/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/video-de-producto-de-joyeria/tests/test_smoke.py`
