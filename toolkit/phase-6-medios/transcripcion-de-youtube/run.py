...
SKILL = {'name': 'Transcripción de YouTube', 'description': 'Extrae subtítulos existentes o recurre automáticamente al reconocimiento de voz por IA si no hay ninguno disponible. Incluye scripts de limpieza de formato para proporcionar texto limpio.', 'slug': 'transcripcion-de-youtube'}
def main() -> int:
