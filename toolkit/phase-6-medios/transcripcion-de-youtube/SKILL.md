---
name: transcripcion-de-youtube
description: Extrae subtítulos existentes o recurre automáticamente al reconocimiento de voz por IA si no hay ninguno disponible. Incluye scripts de limpieza de formato para proporcionar texto limpio.
---

# Transcripción de YouTube

## Propósito
Extrae subtítulos existentes o recurre automáticamente al reconocimiento de voz por IA si no hay ninguno disponible. Incluye scripts de limpieza de formato para proporcionar texto limpio.
