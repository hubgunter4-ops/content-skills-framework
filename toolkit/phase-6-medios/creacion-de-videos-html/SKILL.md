---
name: creacion-de-videos-html
description: Crea videos HTML editables basados en escenas renderizadas a MP4 usando HyperFrames, con animaciones GSAP y subtítulos sincronizados.
---

# Creación de Videos HTML

## Propósito
Crea videos HTML editables basados en escenas renderizadas a MP4 usando HyperFrames, con animaciones GSAP y subtítulos sincronizados.
...
- **Runner:** `toolkit/phase-6-medios/creacion-de-videos-html/run.py`
- **Motor:** `toolkit/phase_6_engine.py`
- **Entrada de ejemplo:** `toolkit/phase-6-medios/creacion-de-videos-html/input.example.json`
- **Esquema de salida:** `toolkit/phase-6-medios/creacion-de-videos-html/output.schema.json`
- **Prueba smoke:** `toolkit/phase-6-medios/creacion-de-videos-html/tests/test_smoke.py`
