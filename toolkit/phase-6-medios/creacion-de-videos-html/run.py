...
SKILL = {'name': 'Creación de Videos HTML', 'description': 'Crea videos HTML editables basados en escenas renderizadas a MP4 usando HyperFrames, con animaciones GSAP y subtítulos sincronizados.', 'slug': 'creacion-de-videos-html'}
def main() -> int:
