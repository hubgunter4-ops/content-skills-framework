...
SKILL = {'name': 'Validación de datos', 'description': 'Realiza controles de calidad QA en los análisis antes de compartirlos con las partes interesadas, comprobando la metodología, verificando la precisión y detectando fuentes de sesgo para aumentar la confianza. Valida la lógica de agregación, señala el posible sesgo de supervivencia y las brechas de reproducibilidad.', 'slug': 'validacion-de-datos'}
