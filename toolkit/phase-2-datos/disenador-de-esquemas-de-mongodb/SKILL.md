...
- **Runner:** `toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `disenador-de-esquemas-de-mongodb` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/run.py \
  --input toolkit/phase-2-datos/disenador-de-esquemas-de-mongodb/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Diseñador de Esquemas de MongoDB` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Diseñador de Esquemas de MongoDB",
