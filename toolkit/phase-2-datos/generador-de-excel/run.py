...
SKILL = {'name': 'Generador de Excel', 'description': 'Crea hojas de cálculo de Excel profesionales con análisis de datos estructurado. Organiza, analiza y presenta datos empresariales y financieros en formatos limpios y listos para su publicación.', 'slug': 'generador-de-excel'}
