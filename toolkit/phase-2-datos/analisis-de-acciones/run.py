...
SKILL = {'name': 'Análisis de acciones', 'description': 'Utiliza datos de mercado, gráficos de precios, información sobre la propiedad y presentaciones ante la SEC para analizar acciones y empresas públicas.', 'slug': 'analisis-de-acciones'}
