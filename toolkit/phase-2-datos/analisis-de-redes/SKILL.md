---
name: analisis-de-redes
description: Conjunto de herramientas de análisis de redes basado en Python que ayuda a crear, analizar y visualizar estructuras de grafos complejas, admitiendo diversos formatos de datos de red. Proporciona algoritmos integrados para calcular rutas más cortas, centralidad y detección de comunidades.
---
...
Conjunto de herramientas de análisis de redes basado en Python que ayuda a crear, analizar y visualizar estructuras de grafos complejas, admitiendo diversos formatos de datos de red. Proporciona algoritmos integrados para calcular rutas más cortas, centralidad y detección de comunidades. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/analisis-de-redes/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `analisis-de-redes` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/analisis-de-redes/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/analisis-de-redes/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/analisis-de-redes/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/analisis-de-redes/run.py \
  --input toolkit/phase-2-datos/analisis-de-redes/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Análisis de Redes` mediante el motor de la Fase 2.
