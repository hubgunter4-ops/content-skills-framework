---
name: disenador-de-dashboards-de-kpi
description: Proporciona patrones de diseño profesionales para dashboards de KPI, cubriendo la selección de métricas, las mejores prácticas de visualización y soluciones de monitoreo en tiempo real con ejemplos de código SQL y Python.
---

# Diseñador de Dashboards de KPI

## Propósito

Proporciona patrones de diseño profesionales para dashboards de KPI, cubriendo la selección de métricas, las mejores prácticas de visualización y soluciones de monitoreo en tiempo real con ejemplos de código SQL y Python. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `disenador-de-dashboards-de-kpi` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/run.py \
  --input toolkit/phase-2-datos/disenador-de-dashboards-de-kpi/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Diseñador de Dashboards de KPI` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Diseñador de Dashboards de KPI",
