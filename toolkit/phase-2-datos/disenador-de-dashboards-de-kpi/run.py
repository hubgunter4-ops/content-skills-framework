...
SKILL = {'name': 'Diseñador de Dashboards de KPI', 'description': 'Proporciona patrones de diseño profesionales para dashboards de KPI, cubriendo la selección de métricas, las mejores prácticas de visualización y soluciones de monitoreo en tiempo real con ejemplos de código SQL y Python.', 'slug': 'disenador-de-dashboards-de-kpi'}
