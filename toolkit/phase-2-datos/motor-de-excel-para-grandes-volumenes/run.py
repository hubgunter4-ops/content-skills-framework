...
SKILL = {'name': 'Motor de Excel para grandes volúmenes', 'description': 'Motor de análisis de alto rendimiento para archivos de Excel con entre 10k y más de 1M de filas, que utiliza lectura en streaming, conversión a Parquet y optimización de memoria. Evita bloqueos por falta de memoria y tiempos de espera agotados para que pueda analizar conjuntos de datos masivos de forma rápida y confiable.', 'slug': 'motor-de-excel-para-grandes-volumenes'}
