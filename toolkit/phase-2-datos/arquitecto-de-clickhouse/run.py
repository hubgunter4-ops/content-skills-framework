...
SKILL = {'name': 'Arquitecto de ClickHouse', 'description': 'Asesor de arquitectura que ayuda a diseñar implementaciones de ClickHouse y a traducir las mejores prácticas en decisiones específicas para su carga de trabajo. Proporciona orientación experta sobre el diseño de clústeres, la optimización de esquemas y el rendimiento de las consultas.', 'slug': 'arquitecto-de-clickhouse'}
