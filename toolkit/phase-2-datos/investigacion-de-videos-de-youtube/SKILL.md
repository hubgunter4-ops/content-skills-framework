---
name: investigacion-de-videos-de-youtube
description: Mejora las investigaciones profundas y los informes con evidencia de videos de YouTube de primera mano, entrevistas a expertos y presentaciones de conferencias.
---

# Investigación de videos de YouTube

## Propósito

Mejora las investigaciones profundas y los informes con evidencia de videos de YouTube de primera mano, entrevistas a expertos y presentaciones de conferencias. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/investigacion-de-videos-de-youtube/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `investigacion-de-videos-de-youtube` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/investigacion-de-videos-de-youtube/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/investigacion-de-videos-de-youtube/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/investigacion-de-videos-de-youtube/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/investigacion-de-videos-de-youtube/run.py \
  --input toolkit/phase-2-datos/investigacion-de-videos-de-youtube/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Investigación de videos de YouTube` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Investigación de videos de YouTube",
