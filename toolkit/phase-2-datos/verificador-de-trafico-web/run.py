...
SKILL = {'name': 'Verificador de tráfico web', 'description': 'Flujo de trabajo de análisis integral del tráfico web compatible con Similarweb, Ahrefs, Semrush, DataForSEO y datos de analítica exportados.', 'slug': 'verificador-de-trafico-web'}
