...
SKILL = {'name': 'Analítica de tráfico web', 'description': 'Analiza el tráfico del sitio web, la interacción, las clasificaciones, las fuentes de tráfico y la distribución geográfica con datos de Similarweb.', 'slug': 'analitica-de-trafico-web'}
