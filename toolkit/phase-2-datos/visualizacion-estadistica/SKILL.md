---
name: visualizacion-estadistica
description: Herramienta de visualización de datos estadísticos que proporciona una interfaz de alto nivel para dibujar gráficos estadísticos con integración de pandas. Ayuda a los usuarios a explorar rápidamente las distribuciones y relaciones de los datos, generando gráficos de calidad de publicación.
---
...
Herramienta de visualización de datos estadísticos que proporciona una interfaz de alto nivel para dibujar gráficos estadísticos con integración de pandas. Ayuda a los usuarios a explorar rápidamente las distribuciones y relaciones de los datos, generando gráficos de calidad de publicación. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/visualizacion-estadistica/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `visualizacion-estadistica` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/visualizacion-estadistica/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/visualizacion-estadistica/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/visualizacion-estadistica/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/visualizacion-estadistica/run.py \
  --input toolkit/phase-2-datos/visualizacion-estadistica/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Visualización Estadística` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Visualización Estadística",
