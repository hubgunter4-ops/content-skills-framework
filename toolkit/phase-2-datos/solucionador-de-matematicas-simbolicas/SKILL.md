---
name: solucionador-de-matematicas-simbolicas
description: Proporciona una guía de SymPy para matemáticas simbólicas exactas en Python, cubriendo álgebra, cálculo, resolución de ecuaciones y generación de código. Ayuda a los usuarios a realizar derivaciones matemáticas precisas, simplificar fórmulas y convertir expresiones simbólicas en código numérico ejecutable o formato LaTeX.
---

# Solucionador de matemáticas simbólicas

## Propósito

Proporciona una guía de SymPy para matemáticas simbólicas exactas en Python, cubriendo álgebra, cálculo, resolución de ecuaciones y generación de código. Ayuda a los usuarios a realizar derivaciones matemáticas precisas, simplificar fórmulas y convertir expresiones simbólicas en código numérico ejecutable o formato LaTeX. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `solucionador-de-matematicas-simbolicas` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/run.py \
  --input toolkit/phase-2-datos/solucionador-de-matematicas-simbolicas/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Solucionador de matemáticas simbólicas` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Solucionador de matemáticas simbólicas",
