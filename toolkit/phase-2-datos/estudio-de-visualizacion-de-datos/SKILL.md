---
name: estudio-de-visualizacion-de-datos
description: Herramienta oficial de visualización de datos de Anthropic con orientación para la selección de gráficos, patrones de código Python para matplotlib, seaborn y plotly, además de principios de diseño y accesibilidad. Ayuda a crear gráficos de calidad de publicación y aptos para daltónicos que comunican hallazgos con claridad.
---

# Estudio de Visualización de Datos

## Propósito

Herramienta oficial de visualización de datos de Anthropic con orientación para la selección de gráficos, patrones de código Python para matplotlib, seaborn y plotly, además de principios de diseño y accesibilidad. Ayuda a crear gráficos de calidad de publicación y aptos para daltónicos que comunican hallazgos con claridad. Esta herramienta prepara un entregable local, estructurado y revisable a partir de la información que proporcione el usuario. No sustituye una investigación de dominio ni convierte una plantilla en evidencia ejecutada.

## Runner asociado

- **Runner:** `toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/run.py`
- **Motor:** `toolkit/phase_2_engine.py`
- **Adaptador:** rama de `build_content()` asociada a `estudio-de-visualizacion-de-datos` o adaptador de datos genérico cuando no existe una rama específica.
- **Entrada de ejemplo:** `toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/input.example.json`
- **Esquema de salida:** `toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/output.schema.json`
- **Prueba smoke:** `toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/tests/test_smoke.py`

La ejecución directa se realiza con:

```bash
python3 toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/run.py \
  --input toolkit/phase-2-datos/estudio-de-visualizacion-de-datos/input.example.json
```
...
4. **Aplicar el adaptador local.** Generar el formato o análisis que corresponda a `Estudio de Visualización de Datos` mediante el motor de la Fase 2.
...
```json
{
  "objective": "Estudio de Visualización de Datos",
