#!/usr/bin/env python3
"""Local, deterministic runner for the Redactor de artículos comparativos skill."""
...
SKILL_NAME = 'Redactor de artículos comparativos'
SKILL_SLUG = 'redactor-de-articulos-comparativos'
SKILL_DESCRIPTION = "Investiga y redacta publicaciones de blog comparativas 'X vs Y' de alta calidad y equilibradas, resúmenes de alternativas de productos y guías de compra con tablas de características estructuradas"
