#!/usr/bin/env python3
"""Local, deterministic runner for the Sin relleno de IA skill."""
...
SKILL_NAME = 'Sin relleno de IA'
SKILL_SLUG = 'sin-relleno-de-ia'
SKILL_DESCRIPTION = 'Una habilidad de edición que elimina más de 20 patrones reveladores de relleno de IA de tus borradores mientras preserva tu voz personal. Consigue una redacción que se lea más nítida, más humana y sea inconfundiblemente tuya'
