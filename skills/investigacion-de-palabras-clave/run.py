#!/usr/bin/env python3
"""Local, deterministic runner for the Investigación de palabras clave skill."""
...
SKILL_NAME = 'Investigación de palabras clave'
SKILL_SLUG = 'investigacion-de-palabras-clave'
SKILL_DESCRIPTION = '. Realice una investigación profesional de palabras'
