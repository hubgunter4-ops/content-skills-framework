#!/usr/bin/env python3
"""Local, deterministic runner for the Investigación de videos de YouTube skill."""
...
SKILL_NAME = 'Investigación de videos de YouTube'
SKILL_SLUG = 'investigacion-de-videos-de-youtube'
SKILL_DESCRIPTION = 'Mejore las investigaciones profundas y los informes con evidencia de videos de YouTube de primera mano, entrevistas a expertos y presentaciones de conferencias'
