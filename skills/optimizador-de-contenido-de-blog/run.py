#!/usr/bin/env python3
"""Local, deterministic runner for the Optimizador de Contenido de Blog skill."""
...
SKILL_NAME = 'Optimizador de Contenido de Blog'
SKILL_SLUG = 'optimizador-de-contenido-de-blog'
SKILL_DESCRIPTION = 'Esta habilidad reescribe y optimiza entradas de blog existentes para mejorar tanto el posicionamiento en Google como las citas de asistentes de IA. Reemplaza automáticamente estadísticas inventadas con datos reales de fuentes, genera gráficos SVG y aplica un formato de respuesta primero, ayudando a los creadores de contenido a actualizar fácilmente artículos obsoletos y aumentar su visibilidad en motores de búsqueda y plataformas de IA'
