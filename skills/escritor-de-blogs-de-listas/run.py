#!/usr/bin/env python3
"""Local, deterministic runner for the Escritor de blogs de listas skill."""
...
SKILL_NAME = 'Escritor de blogs de listas'
SKILL_SLUG = 'escritor-de-blogs-de-listas'
SKILL_DESCRIPTION = 'Redacte artículos de blog tipo listicle y publicaciones recopilatorias optimizados para SEO y GEO/AEO para posicionarse en los motores de búsqueda y obtener citas de motores de IA'
