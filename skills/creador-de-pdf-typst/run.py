#!/usr/bin/env python3
"""Local, deterministic runner for the Creador de PDF Typst skill."""
...
SKILL_NAME = 'Creador de PDF Typst'
SKILL_SLUG = 'creador-de-pdf-typst'
SKILL_DESCRIPTION = 'Genera documentos PDF profesionales y de alta calidad utilizando Typst con tipografía precisa, fórmulas matemáticas y resaltado de código'
