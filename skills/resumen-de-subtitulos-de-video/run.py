#!/usr/bin/env python3
"""Local, deterministic runner for the Resumen de subtítulos de vídeo skill."""
...
SKILL_NAME = 'Resumen de subtítulos de vídeo'
SKILL_SLUG = 'resumen-de-subtitulos-de-video'
SKILL_DESCRIPTION = 'Esta habilidad convierte vídeos de Douyin, Xiaohongshu, Bilibili, YouTube o archivos locales en subtítulos y resúmenes de IA utilizando la transcripción local faster-whisper. Obtiene los subtítulos de YouTube directamente cuando están disponibles, para que puedas obtener texto en el que se pueden realizar búsquedas y puntos clave de cualquier vídeo en cuestión de minutos'
