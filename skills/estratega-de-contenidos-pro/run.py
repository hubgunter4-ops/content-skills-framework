#!/usr/bin/env python3
"""Local, deterministic runner for the Estratega de Contenidos Pro skill."""
...
SKILL_NAME = 'Estratega de Contenidos Pro'
SKILL_SLUG = 'estratega-de-contenidos-pro'
SKILL_DESCRIPTION = 'Este kit de herramientas de marketing profesional le ayuda a planificar estrategias de contenido al decidir qué temas y formatos priorizar. Proporciona orientación práctica para diversos escenarios de marketing, permitiendo que los equipos alineen sus esfuerzos de contenido con los objetivos comerciales y ejecuten campañas de manera más efectiva'
