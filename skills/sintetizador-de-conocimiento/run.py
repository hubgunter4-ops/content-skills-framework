#!/usr/bin/env python3
"""Local, deterministic runner for the Sintetizador de Conocimiento skill."""
...
SKILL_NAME = 'Sintetizador de Conocimiento'
SKILL_SLUG = 'sintetizador-de-conocimiento'
SKILL_DESCRIPTION = 'Esta herramienta sintetiza los resultados de búsqueda de múltiples fuentes en respuestas coherentes y sin duplicados, con una clara atribución de fuentes y puntuación de confianza. Pondera la actualidad y la autoridad para mostrar la información más fiable y comprime grandes conjuntos de resultados en resúmenes concisos y prácticos para informes, agentes o sesiones informativas para las partes interesadas'
