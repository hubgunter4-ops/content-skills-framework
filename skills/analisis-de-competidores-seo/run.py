#!/usr/bin/env python3
"""Local, deterministic runner for the Análisis de competidores SEO skill."""
...
SKILL_NAME = 'Análisis de competidores SEO'
SKILL_SLUG = 'analisis-de-competidores-seo'
SKILL_DESCRIPTION = 'Cree informes simplificados de competidores orgánicos de SEO centrados en los objetivos, modelados según el estilo de informe aprobado de hix.ai, con gráficos de apoyo y prioridades a 90 días'
