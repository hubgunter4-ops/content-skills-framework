#!/usr/bin/env python3
"""Local, deterministic runner for the Análisis de brechas de contenido skill."""
...
SKILL_NAME = 'Análisis de brechas de contenido'
SKILL_SLUG = 'analisis-de-brechas-de-contenido'
SKILL_DESCRIPTION = '. Identifica y prioriza las brechas de contenido del sitio web comparándolas con los competidores y la demanda de búsqueda utilizando Ahrefs, Semrush o datos públicos de las SERP'
