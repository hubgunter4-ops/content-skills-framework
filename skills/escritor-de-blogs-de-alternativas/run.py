#!/usr/bin/env python3
"""Local, deterministic runner for the Escritor de blogs de alternativas skill."""
...
SKILL_NAME = 'Escritor de blogs de alternativas'
SKILL_SLUG = 'escritor-de-blogs-de-alternativas'
SKILL_DESCRIPTION = 'Escribe artículos de blog de comparación de competidores y alternativas optimizados para SEO para captar tráfico de búsqueda orgánica'
