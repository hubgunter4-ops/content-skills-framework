#!/usr/bin/env python3
"""Local, deterministic runner for the Generador de informes de auditoría SEO skill."""
...
SKILL_NAME = 'Generador de informes de auditoría SEO'
SKILL_SLUG = 'generador-de-informes-de-auditoria-seo'
SKILL_DESCRIPTION = 'Cree informes de auditoría SEO en lenguaje sencillo y basados en pruebas, con resúmenes ejecutivos estructurados y listas de correcciones priorizadas basadas estrictamente en los datos del informe'
