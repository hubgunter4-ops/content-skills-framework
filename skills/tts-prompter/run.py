#!/usr/bin/env python3
"""Local, deterministic runner for the TTS Prompter skill."""
...
SKILL_NAME = 'TTS Prompter'
SKILL_SLUG = 'tts-prompter'
SKILL_DESCRIPTION = 'Domina la creación de prompts de texto a voz con marcos estructurados, separación de estilos y etiquetas de marcado expresivas'
