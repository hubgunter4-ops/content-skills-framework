#!/usr/bin/env python3
"""Local, deterministic runner for the Diseñador de artículos editoriales skill."""
...
SKILL_NAME = 'Diseñador de artículos editoriales'
SKILL_SLUG = 'disenador-de-articulos-editoriales'
